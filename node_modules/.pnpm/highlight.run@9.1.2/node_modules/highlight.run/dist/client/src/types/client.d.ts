...
export declare interface MixpanelIntegrationOptions extends DefaultIntegrationOptions {
    projectToken?: string;
}
export declare interface AmplitudeIntegrationOptions extends DefaultIntegrationOptions {
    apiKey?: string;
}
export declare interface IntercomIntegrationOptions extends DefaultIntegrationOptions {
}
