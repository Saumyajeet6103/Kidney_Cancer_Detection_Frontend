import { d as Nn } from "./index-bWmur_Kt.js";
function Ua(Et, Mt) {
...
(function(Et, Mt) {
  (function(fe, Ke) {
    ...
    function gr(t, e) {
      const { doc: i, mirror: n, blockClass: s, blockSelector: o, needsMask: r, inlineStylesheet: a, maskInputOptions: l = {}, maskTextClass: c, maskTextFn: d, maskInputFn: h, dataURLOptions: p = {}, inlineImages: m, recordCanvas: X, keepIframeSrcFn: y, newlyAddedElement: G = !1, privacySetting: Z } = e, g = function(b, I) {
        if (!I.hasNode(b))
          return;
        const R = I.getId(b);
        return R === 1 ? void 0 : R;
      ...
      switch (t.nodeType) {
        ...
        case t.ELEMENT_NODE:
          return function(b, I) {
            const { doc: R, blockClass: L, blockSelector: F, inlineStylesheet: H, maskInputOptions: x = {}, maskInputFn: N, maskTextClass: K, dataURLOptions: k = {}, inlineImages: u, recordCanvas: V, keepIframeSrcFn: v, newlyAddedElement: W = !1, privacySetting: M, rootId: S } = I;
            let T = qn(b, L, F);
            ...
            if (B === "option" && (b.selected && !x.select ? z.selected = !0 : delete z.selected), B === "canvas" && V) {
              if (b.__context === "2d")
                (function(J) {
        ...
        case t.TEXT_NODE:
          return function(b, I) {
            ...
            v ? (u = "SCRIPT_PLACEHOLDER", W = !0) : k === "NOSCRIPT" && (u = "", W = !0), !V && !v && u && F && (u = H ? H(u, wi(b)) : u.replace(/[\S]/g, "*"));
      ...
      constructor() {
        C(this, "frozen", !1), C(this, "locked", !1), C(this, "texts", []), C(this, "attributes", []), C(this, "attributeMap", /* @__PURE__ */ new WeakMap()), C(this, "removes", []), C(this, "mapRemoves", []), C(this, "movedMap", {}), C(this, "addedSet", /* @__PURE__ */ new Set()), C(this, "movedSet", /* @__PURE__ */ new Set()), C(this, "droppedSet", /* @__PURE__ */ new Set()), C(this, "mutationCb"), C(this, "blockClass"), C(this, "blockSelector"), C(this, "maskTextClass"), C(this, "maskTextSelector"), C(this, "inlineStylesheet"), C(this, "maskInputOptions"), C(this, "maskTextFn"), C(this, "maskInputFn"), C(this, "keepIframeSrcFn"), C(this, "recordCanvas"), C(this, "inlineImages"), C(this, "privacySetting"), C(this, "slimDOMOptions"), C(this, "dataURLOptions"), C(this, "doc"), C(this, "mirror"), C(this, "iframeManager"), C(this, "stylesheetManager"), C(this, "shadowDomManager"), C(this, "canvasManager"), C(this, "processedNodeManager"), C(this, "unattachedDoc"), C(this, "processMutations", (e) => {
          ...
          if (!this.processedNodeManager.inOtherBuffer(e, this) && !this.addedSet.has(e) && !this.movedSet.has(e)) {
            ...
            me(e, this.blockClass, this.blockSelector, !1) || (_t(e).forEach((n) => this.genAdds(n)), Pi(e) && _t(ft(e)).forEach((n) => {
      ...
      const X = function(Z) {
        ...
        const H = _(() => {
          ...
          for (let k = 0; k < K; k++) {
            ...
            me(V, I, R, !0) || me(W, I, R, !0) || N.push({ start: b.getId(V), startOffset: v, end: b.getId(W), endOffset: M });
          }
          L({ ranges: N });
        });
          ...
          for (const m of p)
            try {
              ...
              const y = $t(l.CanvasRenderingContext2D.prototype, m, { set(G) {
                a(this.canvas, { type: dt["2D"], property: m, args: [G], setter: !0 });
              } });
              h.push(y);
            }
          return () => {
    ...
    function Fe(t = {}) {
      ...
      ri = (D = !1) => {
        ...
        const Le = function(ie, se) {
          const { mirror: ke = new Mn(), blockClass: ee = "highlight-block", blockSelector: Ht = null, maskTextClass: Va = "highlight-mask", maskTextSelector: Ga = null, inlineStylesheet: fa = !0, inlineImages: Wa = !1, recordCanvas: Ra = !1, maskAllInputs: wn = !1, maskTextFn: va, maskInputFn: Ca, slimDOM: vi = !1, dataURLOptions: ka, preserveWhiteSpace: Ta, onSerialize: wa, onIframeLoad: Na, iframeLoadTimeout: La, onStylesheetLoad: xa, stylesheetLoadTimeout: Ja, keepIframeSrcFn: Ya = () => !1, privacySetting: Ka = "default" } = se || {};
          return ot(ie, { doc: ie, mirror: ke, blockClass: ee, blockSelector: Ht, maskTextClass: Va, maskTextSelector: Ga, skipChild: !1, inlineStylesheet: fa, maskInputOptions: wn === !0 ? { color: !0, date: !0, "datetime-local": !0, email: !0, month: !0, number: !0, range: !0, search: !0, tel: !0, text: !0, time: !0, url: !0, week: !0, textarea: !0, select: !0, password: !0 } : wn === !1 ? { password: !0 } : wn, maskTextFn: va, maskInputFn: Ca, slimDOMOptions: vi || vi === "all" ? { script: !0, comment: !0, headFavicon: !0, headWhitespace: !0, headMetaDescKeywords: vi === "all", headMetaSocial: !0, headMetaRobots: !0, headMetaHttpEquiv: !0, headMetaAuthorship: !0, headMetaVerification: !0 } : vi || {}, dataURLOptions: ka, inlineImages: Wa, recordCanvas: Ra, preserveWhiteSpace: Ta, onSerialize: wa, onIframeLoad: Na, iframeLoadTimeout: La, onStylesheetLoad: xa, stylesheetLoadTimeout: Ja, keepIframeSrcFn: Ya, newlyAddedElement: !1, privacySetting: Ka });
...
`).filter(function(e) {
    ...
    var jr = { REACT_APP_COMMIT_SHA: "7e6f483f79dd1bb79a01e572dac9885e69c8234d", BASE_URL: "/", MODE: "production", DEV: !1, PROD: !0, SSR: !1 };
    ...
    const $s = () => {
      ...
      return r.open = function(d, h) {
        ...
        return this.addEventListener("load", function() {
          ...
          return ne(this, null, function* () {
            ...
            t({ request: X, response: y, urlBlocked: !1 });
          });
      ...
      t.then((r) => ne(this, null, function* () {
        ...
        "stack" in r || r instanceof Error ? (a = Ve(U({}, a), { body: r.message, status: 0, size: void 0 }), l = !0) : "status" in r && (a = Ve(U({}, a), { status: r.status }), n && (a.body = yield il(r, o, s), a.headers = Object.fromEntries(r.headers.entries()), a.size = 8 * a.body.length), r.type !== "opaque" && r.type !== "opaqueredirect" || (c = !0, a = Ve(U({}, a), { body: "CORS blocked request" })), l = !0), l && i({ request: e, response: a, urlBlocked: c });
      })).catch(() => {
      });
    ...
    var sl = { REACT_APP_COMMIT_SHA: "7e6f483f79dd1bb79a01e572dac9885e69c8234d", BASE_URL: "/", MODE: "production", DEV: !1, PROD: !0, SSR: !1 };
    class He {
      constructor(e) {
        var i, n;
    ...
    function rn(t, e) {
      ...
      for (const s of t.body.matchAll(ll)) {
        if (typeof s.index == "number" || rl(!1), s.index >= e)
          break;
...
spurious results.`);
    ...
    class Wl {
      ...
      parseOperationDefinition() {
        ...
        let n;
        return this.peek(f.NAME) && (n = this.parseName()), this.node(e, { kind: E.OPERATION_DEFINITION, operation: i, name: n, variableDefinitions: this.parseVariableDefinitions(), directives: this.parseDirectives(!1), selectionSet: this.parseSelectionSet() });
      }
      parseOperationType() {
        const e = this.expectToken(f.NAME);
        switch (e.value) {
      ...
      parseField() {
        ...
        let n, s;
        return this.expectOptionalToken(f.COLON) ? (n = i, s = this.parseName()) : s = i, this.node(e, { kind: E.FIELD, alias: n, name: s, arguments: this.parseArguments(!1), directives: this.parseDirectives(!1), selectionSet: this.peek(f.BRACE_L) ? this.parseSelectionSet() : void 0 });
      }
      parseArguments(e) {
      ...
      parseFragment() {
        ...
        return !i && this.peek(f.NAME) ? this.node(e, { kind: E.FRAGMENT_SPREAD, name: this.parseFragmentName(), directives: this.parseDirectives(!1) }) : this.node(e, { kind: E.INLINE_FRAGMENT, typeCondition: i ? this.parseNamedType() : void 0, directives: this.parseDirectives(!1), selectionSet: this.parseSelectionSet() });
      }
      ...
      node(e, i) {
        return this._options.noLocation !== !0 && (i.loc = new al(e, this._lexer.lastToken, this._lexer.source)), i;
      }
      peek(e) {
      ...
      expectOptionalKeyword(e) {
        const i = this._lexer.token;
        return i.kind === f.NAME && i.value === e && (this.advanceLexer(), !0);
      }
      unexpected(e) {
      ...
      i = s, function(r) {
        ...
        function H(u, V) {
          ...
          if (u instanceof H) {
            ...
            this.url = u.url, this.credentials = u.credentials, V.headers || (this.headers = new Z(u.headers)), this.method = u.method, this.mode = u.mode, this.signal = u.signal, M || u._bodyInit == null || (M = u._bodyInit, u.bodyUsed = !0);
          } else
            this.url = String(u);
        ...
        k.polyfill = !0, i.fetch || (i.fetch = k, i.Headers = Z, i.Request = H, i.Response = N), r.Headers = Z, r.Request = H, r.Response = N, r.fetch = k, Object.defineProperty(r, "__esModule", { value: !0 });
...
`, _l = (t, e, i, n) => t(), ql = (t) => {
    ...
    const ea = (t) => {
      ...
      for (let a = 0; a < i.length; a++) {
        let l = i[a].split("+");
        n = [], l.length > 1 && (n = sa(To, l)), l = l[l.length - 1], l = l === "*" ? "*" : na(l), l in Je || (Je[l] = []), Je[l].push({ mods: n, shortcut: i[a], key: i[a], method: e, keyup: !1, keydown: !0, scope: "all", splitKey: "+" });
      }
      var s, o, r;
    ...
    let ye = [];
    const Je = {}, In = typeof navigator != "undefined" && navigator.userAgent.toLowerCase().indexOf("firefox") > 0, ia = { backspace: 8, tab: 9, clear: 12, enter: 13, return: 13, esc: 27, escape: 27, space: 32, left: 37, up: 38, right: 39, down: 40, del: 46, delete: 46, ins: 45, insert: 45, home: 36, end: 35, pageup: 33, pagedown: 34, capslock: 20, num_0: 96, num_1: 97, num_2: 98, num_3: 99, num_4: 100, num_5: 101, num_6: 102, num_7: 103, num_8: 104, num_9: 105, num_multiply: 106, num_add: 107, num_enter: 108, num_subtract: 109, num_decimal: 110, num_divide: 111, "⇪": 20, ",": 188, ".": 190, "/": 191, "`": 192, "-": In ? 173 : 189, "=": In ? 61 : 187, ";": In ? 59 : 186, "'": 222, "[": 219, "]": 221, "\\": 220 }, ko = { 16: "shiftKey", 18: "altKey", 17: "ctrlKey", 91: "metaKey", shiftKey: 16, ctrlKey: 17, altKey: 18, metaKey: 91 }, ge = { 16: !1, 18: !1, 17: !1, 91: !1 }, To = { "⇧": 16, shift: 16, "⌥": 18, alt: 18, option: 18, "⌃": 17, ctrl: 17, control: 17, "⌘": 91, cmd: 91, command: 91 }, na = (t) => ia[t.toLowerCase()] || To[t.toLowerCase()] || t.toUpperCase().charCodeAt(0);
    function sa(t, e) {
    ...
    var Oe, xt, wo, gi, Sn, No = -1, $e = function(t) {
    ...
    }, Ko = [0.1, 0.25], Yt = { passive: !0, capture: !0 }, la = /* @__PURE__ */ new Date(), Uo = function(t, e) {
      ...
      e = e || {}, Jt(function() {
        var i;
        "interactionCount" in performance || Sn || (Sn = yt("event", ca, { type: "event", buffered: !0, durationThreshold: 0 }));
...
`, " ")));
    ...
    class kn {
      constructor(e, i) {
        var n, s, o, r, a, l;
        w(this, "options"), w(this, "isRunningOnHighlight"), w(this, "organizationID"), w(this, "graphqlSDK"), w(this, "events"), w(this, "sessionData"), w(this, "ready"), w(this, "manualStopped"), w(this, "state"), w(this, "logger"), w(this, "enableSegmentIntegration"), w(this, "privacySetting"), w(this, "enableCanvasRecording"), w(this, "enablePerformanceRecording"), w(this, "samplingStrategy"), w(this, "inlineImages"), w(this, "inlineStylesheet"), w(this, "debugOptions"), w(this, "listeners"), w(this, "firstloadVersion"), w(this, "environment"), w(this, "sessionShortcut"), w(this, "appVersion"), w(this, "serviceName"), w(this, "_worker"), w(this, "_optionsInternal"), w(this, "_backendUrl"), w(this, "_recordingStartTime"), w(this, "_isOnLocalHost"), w(this, "_onToggleFeedbackFormVisibility"), w(this, "_firstLoadListeners"), w(this, "_isCrossOriginIframe"), w(this, "_eventBytesSinceSnapshot"), w(this, "_lastSnapshotTime"), w(this, "_lastVisibilityChangeTime"), w(this, "pushPayloadTimerId"), w(this, "hasSessionUnloaded"), w(this, "hasPushedData"), w(this, "reloaded"), w(this, "_hasPreviouslyInitialized"), w(this, "_payloadId"), w(this, "_recordStop"), e.sessionSecureID || (e.sessionSecureID = Gi()), this.options = e, typeof ((n = this.options) == null ? void 0 : n.debug) == "boolean" ? this.debugOptions = this.options.debug ? { clientInteractions: !0 } : {} : this.debugOptions = (o = (s = this.options) == null ? void 0 : s.debug) != null ? o : {}, this.logger = new Ia(this.debugOptions.clientInteractions), e.storageMode && (this.logger.log(`initializing in ${e.storageMode} session mode`), l = e.storageMode, qi = l), this._worker = new Za(), this._worker.onmessage = (d) => {
          var h, p;
      ...
      _initMembers(e) {
        ...
        this._optionsInternal = G, this.listeners = [], this.events = [], this.hasSessionUnloaded = !1, this.hasPushedData = !1, window.Intercom && window.Intercom("onShow", () => {
...
var Fa = Ln.exports;
const Ea = /* @__PURE__ */ Ua({
  __proto__: null
}, [Fa]);
export {
  Ea as i
};
//# sourceMappingURL=index-mTHZ-EGL.js.map
