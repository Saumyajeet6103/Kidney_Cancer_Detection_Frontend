...
class Z {
  ...
  startListening() {
    ...
    }, { enablePromisePatch: this.enablePromisePatch })), this.options.enableOtelTracing && import("./index-BYNUbnPS.js").then(({ shutdown: r }) => {
...
const b = {
  ...
  init: (t, e) => {
    ...
    try {
      ...
      fe = !0, e != null && e.enableOtelTracing && import("./index-BYNUbnPS.js").then(({ setupBrowserTracing: h, getTracer: m }) => {
        var f, w;
        h({
      ...
      }), V(), K(), import("./index-mTHZ-EGL.js").then((h) => h.i).then((m) => _(void 0, [m], function* ({ Highlight: h }) {
...
//# sourceMappingURL=index-bWmur_Kt.js.map
