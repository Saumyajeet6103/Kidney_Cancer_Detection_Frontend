// node_modules/.pnpm/highlight.run@9.1.2/node_modules/highlight.run/dist/index-bWmur_Kt.js
...
var T = (t, e, r) => e in t ? _e(t, e, { enumerable: true, configurable: true, writable: true, value: r }) : t[e] = r;
var k = (t, e) => {
  for (var r in e || (e = {}))
...
var Ce = ({ apiKey: t }) => {
  (function(e, r) {
    ...
    s.type = "text/javascript", s.integrity = "sha384-+EO59vL/X7v6VE2s6/F4HxfHlK0nDUVWKVg8K9oUlvffAeeaShVBmbORTC2D3UF+", s.crossOrigin = "anonymous", s.async = true, s.src = "https://cdn.amplitude.com/libs/amplitude-8.17.0-min.gz.js", s.onload = function() {
...
var He = "https://cdn.mxpnl.com/libs/mixpanel-2-latest.min.js";
function Ie(t, e, r) {
  try {
    if (!(e in t))
      return () => {
...
function W(t, e) {
  ...
  return JSON.stringify(t, function(d, n) {
    ...
    if (n instanceof Event) {
      ...
      for (const o in n) {
        const u = n[o];
        Array.isArray(u) ? c[o] = Pe(u.length ? u[0] : null) : c[o] = u;
      }
      return c;
    } else {
  ...
  function l(d) {
    return M(d) && Object.keys(d).length > r.numOfKeysLimit || typeof d == "function" ? true : d instanceof Event && d.isTrusted === false ? Object.keys(d).length === 1 : !!(M(d) && ge(d, r.depthOfLimit));
  }
  function a(d) {
    let n = d.toString();
...
var ye = (t) => pe().getItem(t);
var Ve = (t, e) => pe().setItem(t, e);
var Ke = 15 * 60 * 1e3;
var Ge = () => {
  let t = JSON.parse(ye(I.SESSION_DATA) || "{}");
  if (t && t.lastPushTime && Date.now() - t.lastPushTime < Ke)
    return t;
};
var be = function() {
  var t;
  return (t = ye(I.SESSION_SECURE_ID)) != null ? t : "";
};
var Je = { BASE_URL: "/", MODE: "production", DEV: false, PROD: true, SSR: false };
var ke = "X-Highlight-Request";
var ae = (t) => {
  let e = t;
  return !t.startsWith("https://") && !t.startsWith("http://") && (e = `${window.location.origin}${e}`), e.replace(/\/+$/, "");
};
var Xe = (t, { headersToRedact: e, headersToRecord: r, requestResponseSanitizer: i }) => {
  var n, c;
  let s = t;
  if (i) {
    let u = true;
...
var J = (t, e, r) => !Qe(t, e) || X(t, r);
var X = (t, e) => {
  var s;
  let r = [];
  e === true ? (r = ["localhost", /^\//], (s = window == null ? void 0 : window.location) != null && s.host && r.push(window.location.host)) : e instanceof Array && (r = e);
  let i = false;
  return r.forEach((l) => {
    t.match(l) && (i = true);
  }), i;
...
var nt = (t, e, r, i, s, l) => {
  const a = (d) => _(void 0, null, function* () {
    ...
    "stack" in d || d instanceof Error ? (n = v(k({}, n), {
      ...
      status: 0,
      size: void 0
    }), c = true) : "status" in d && (n = v(k({}, n), {
      status: d.status
    }), i && (n.body = yield it(d, l, s), n.headers = Object.fromEntries(d.headers.entries()), n.size = n.body.length * 8), (d.type === "opaque" || d.type === "opaqueredirect") && (o = true, n = v(k({}, n), {
...
var it = (t, e, r) => _(void 0, null, function* () {
  let i;
  try {
...
var ot = ({ xhrCallback: t, fetchCallback: e, webSocketRequestCallback: r, webSocketEventCallback: i, disableWebSocketRecording: s, bodyKeysToRedact: l, backendUrl: a, tracingOrigins: d, urlBlocklist: n, sessionSecureID: c, bodyKeysToRecord: o }) => {
...
var at = { BASE_URL: "/", MODE: "production", DEV: false, PROD: true, SSR: false };
var Z = class _Z {
  constructor(e) {
    ...
    y(this, "messages");
    y(this, "options");
    y(this, "hasNetworkRecording", true);
    y(this, "_backendUrl");
    ...
    var r, i;
    this.options = e, this.disableConsoleRecording = !!e.disableConsoleRecording, this.reportConsoleErrors = (r = e.reportConsoleErrors) != null ? r : false, this.enablePromisePatch = (i = e.enablePromisePatch) != null ? i : true, this.consoleMethodsToRecord = e.consoleMethodsToRecord || [
      ...Ue
  ...
  startListening() {
    ...
    }, { enablePromisePatch: this.enablePromisePatch })), this.options.enableOtelTracing && import("./index-BYNUbnPS-74UVQ3YK.js").then(({ shutdown: r }) => {
      this.listeners.push(r);
    }), _Z.setupNetworkListener(this, this.options);
  }
  stopListening() {
  ...
  static setupNetworkListener(e, r) {
    ...
    e._backendUrl = (r == null ? void 0 : r.backendUrl) || at.REACT_APP_PUBLIC_GRAPH_URI || "https://pub.highlight.run", e.xhrNetworkContents = [], e.fetchNetworkContents = [], e.webSocketNetworkContents = [], e.webSocketEventContents = [], e.networkHeadersToRedact = [], e.urlBlocklist = [], e.tracingOrigins = r.tracingOrigins || [], (r == null ? void 0 : r.disableNetworkRecording) !== void 0 ? (e.disableNetworkRecording = r == null ? void 0 : r.disableNetworkRecording, e.enableRecordingNetworkContents = false, e.disableRecordingWebSocketContents = true, e.networkHeadersToRedact = [], e.networkBodyKeysToRedact = [], e.urlBlocklist = [], e.networkBodyKeysToRecord = [], e.networkBodyKeysToRecord = []) : typeof (r == null ? void 0 : r.networkRecording) == "boolean" ? (e.disableNetworkRecording = !r.networkRecording, e.enableRecordingNetworkContents = false, e.disableRecordingWebSocketContents = true, e.networkHeadersToRedact = [], e.networkBodyKeysToRedact = [], e.urlBlocklist = []) : (((i = r.networkRecording) == null ? void 0 : i.enabled) !== void 0 ? e.disableNetworkRecording = !r.networkRecording.enabled : e.disableNetworkRecording = false, e.enableRecordingNetworkContents = ((s = r.networkRecording) == null ? void 0 : s.recordHeadersAndBody) || false, e.disableRecordingWebSocketContents = ((l = r.networkRecording) == null ? void 0 : l.disableWebSocketEventRecordings) || false, e.networkHeadersToRedact = ((d = (a = r.networkRecording) == null ? void 0 : a.networkHeadersToRedact) == null ? void 0 : d.map((f) => f.toLowerCase())) || [], e.networkBodyKeysToRedact = ((c = (n = r.networkRecording) == null ? void 0 : n.networkBodyKeysToRedact) == null ? void 0 : c.map((f) => f.toLowerCase())) || [], e.urlBlocklist = ((u = (o = r.networkRecording) == null ? void 0 : o.urlBlocklist) == null ? void 0 : u.map((f) => f.toLowerCase())) || [], e.urlBlocklist = [
      ...e.urlBlocklist,
      ...ze
  ...
  static getRecordedNetworkResources(e, r) {
    ...
    if (!e.disableNetworkRecording) {
      ...
      const n = (r - d) * 2;
      if (i = i.filter((c) => c.responseEnd < e.lastNetworkRequestTimestamp ? false : J(c.name, e._backendUrl, e.tracingOrigins)).map((c) => v(k({}, c.toJSON()), {
...
var b = {
  ...
  init: (t, e) => {
    ...
    try {
      ...
      if (o != null && o.sessionSecureID)
        ...
        Ve(I.SESSION_DATA, JSON.stringify(h));
      }
      if (fe)
        return { sessionSecureID: u };
      fe = true, e != null && e.enableOtelTracing && import("./index-BYNUbnPS-74UVQ3YK.js").then(({ setupBrowserTracing: h, getTracer: m }) => {
        var f, w;
        h({
      ...
      }), V(), K(), import("./index-mTHZ-EGL-FJNG3J5V.js").then((h) => h.i).then((m) => _(void 0, [m], function* ({ Highlight: h }) {
        p = new h(g, q), V(), K(), e != null && e.manualStart || (yield p.initialize());
      }));
      const g = {
        organizationID: t,
  ...
  start: (t) => {
    (p == null ? void 0 : p.state) === "Recording" && !(t != null && t.forceNew) ? t != null && t.silent || console.warn("Highlight is already recording. Please `H.stop()` the current session before starting a new one.") : (q.startListening(), b.onHighlightReady(() => _(void 0, null, function* () {
      yield p.initialize(t);
    }), { waitForReady: false }));
  },
  stop: (t) => {
    (p == null ? void 0 : p.state) !== "Recording" ? t != null && t.silent || console.warn("Highlight is already stopped. Please call `H.start()`.") : b.onHighlightReady(() => p.stopRecording(true));
  },
  identify: (t, e = {}) => {
    var r, i, s, l, a, d, n, c;
    try {
  ...
  startSpan: (t, e, r, i) => {
    const s = typeof H == "function" ? H() : void 0;
    if (!s)
  ...
  onHighlightReady: (t, e) => {
    if (A.push({ options: e, func: t }), $ === void 0) {
      const r = () => {
        var s;
        const i = [];
        for (const l of A)
          p && (((s = l.options) == null ? void 0 : s.waitForReady) === false || p.ready) ? l.func() : i.push(l);
        A = i, $ = void 0, A.length > 0 && ($ = setTimeout(r, ut));
      };
      r();
    }
  }
...
//# sourceMappingURL=chunk-RPAAKSGY.js.map
