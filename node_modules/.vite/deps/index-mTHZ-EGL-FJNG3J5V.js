import {
  he
} from "./chunk-RPAAKSGY.js";
import "./chunk-VRMXEQCD.js";

// node_modules/.pnpm/highlight.run@9.1.2/node_modules/highlight.run/dist/index-mTHZ-EGL.js
function Ua(Et, Mt) {
...
(function(Et, Mt) {
  (function(fe, Ke) {
    ...
    var Ke = Object.defineProperty, Be = Object.defineProperties, It = Object.getOwnPropertyDescriptors, zt = Object.getOwnPropertySymbols, xn = Object.prototype.hasOwnProperty, Jn = Object.prototype.propertyIsEnumerable, Ci = (t, e, i) => e in t ? Ke(t, e, { enumerable: true, configurable: true, writable: true, value: i }) : t[e] = i, U = (t, e) => {
      for (var i in e || (e = {}))
        ...
        if (typeof n != "string" && !Array.isArray(n)) {
          for (const s in n)
            if (s !== "default" && !(s in t)) {
              ...
              o && Object.defineProperty(t, s, o.get ? o : { enumerable: true, get: () => n[s] });
            }
        }
      }
    ...
    var Yn, rr = Object.defineProperty, C = (t, e, i) => (((n, s, o) => {
      s in n ? rr(n, s, { enumerable: true, configurable: true, writable: true, value: o }) : n[s] = o;
    })(t, typeof e != "symbol" ? e + "" : e, i), i), lr = Object.defineProperty, Kn = (t, e, i) => (((n, s, o) => {
      s in n ? lr(n, s, { enumerable: true, configurable: true, writable: true, value: o }) : n[s] = o;
    ...
    function it(t, e, i) {
      ...
      const o = function(a) {
        ...
        const l = globalThis[a], c = l.prototype, d = a in Un ? Un[a] : void 0, h = !!(d && d.every((X) => {
          var y, G;
          return !!((G = (y = Object.getOwnPropertyDescriptor(c, X)) == null ? void 0 : y.get) != null && G.toString().includes("[native code]"));
        })), p = a in Fn ? Fn[a] : void 0, m = !!(p && p.every((X) => {
          var y;
          return typeof c[X] == "function" && ((y = c[X]) == null ? void 0 : y.toString().includes("[native code]"));
        }));
        if (h && m)
        ...
        try {
          ...
          const y = X.contentWindow;
          if (!y)
            return l.prototype;
          const G = y[a].prototype;
          return document.body.removeChild(X), G ? Ot[a] = G : c;
        } catch (X) {
          return c;
        }
    ...
    function gr(t, e) {
      const { doc: i, mirror: n, blockClass: s, blockSelector: o, needsMask: r, inlineStylesheet: a, maskInputOptions: l = {}, maskTextClass: c, maskTextFn: d, maskInputFn: h, dataURLOptions: p = {}, inlineImages: m, recordCanvas: X, keepIframeSrcFn: y, newlyAddedElement: G = false, privacySetting: Z } = e, g = function(b, I) {
        if (!I.hasNode(b))
          return;
        const R = I.getId(b);
        return R === 1 ? void 0 : R;
      ...
      switch (t.nodeType) {
        ...
        case t.ELEMENT_NODE:
          return function(b, I) {
            const { doc: R, blockClass: L, blockSelector: F, inlineStylesheet: H, maskInputOptions: x = {}, maskInputFn: N, maskTextClass: K, dataURLOptions: k = {}, inlineImages: u, recordCanvas: V, keepIframeSrcFn: v, newlyAddedElement: W = false, privacySetting: M, rootId: S } = I;
            let T = qn(b, L, F);
            ...
            if (B === "option" && (b.selected && !x.select ? z.selected = true : delete z.selected), B === "canvas" && V) {
              if (b.__context === "2d")
                (function(J) {
                  ...
                  for (let ue = 0; ue < J.width; ue += 50)
                    for (let pe = 0; pe < J.height; pe += 50) {
                      ...
                      if (new Uint32Array(Ft.call(P, ue, pe, Math.min(50, J.width - ue), Math.min(50, J.height - pe)).data.buffer).some((fi) => fi !== 0))
                        return false;
                    }
                  return true;
            ...
            if (W || (b.scrollLeft && (z.rr_scrollLeft = b.scrollLeft), b.scrollTop && (z.rr_scrollTop = b.scrollTop)), T || $ || A && Ki(B)) {
              const { width: J, height: P } = b.getBoundingClientRect();
              z = { class: z.class, rr_width: `${J}px`, rr_height: `${P}px` };
            }
            A && Ki(B) && (T = true), B !== "iframe" || v(z.src) || (b.contentDocument || (z.rr_src = z.src), delete z.src);
            let be;
            try {
              customElements.get(B) && (be = true);
            } catch (J) {
            }
            if (u && B === "video") {
              const J = b;
              if (J.src === "" || J.src.indexOf("blob:") !== -1) {
                ...
                z = { width: P, height: ue, rr_width: `${P}px`, rr_height: `${ue}px`, rr_inlined_video: true }, B = "canvas";
          ...
          }(t, { doc: i, blockClass: s, blockSelector: o, inlineStylesheet: a, maskInputOptions: l, maskInputFn: h, maskTextClass: c, dataURLOptions: p, inlineImages: m, recordCanvas: X, keepIframeSrcFn: y, newlyAddedElement: G, privacySetting: Z, rootId: g });
        case t.TEXT_NODE:
          return function(b, I) {
            var R, L;
            const { needsMask: F, maskTextFn: H, privacySetting: x, rootId: N } = I, K = Pt(b), k = K && K.tagName;
            let u = Ni(b);
            const V = k === "STYLE" || void 0, v = k === "SCRIPT" || void 0;
            let W = false;
            if (V && u) {
              try {
              ...
              u = Dt(u, Qt(I.doc)), W = true;
            }
            v ? (u = "SCRIPT_PLACEHOLDER", W = true) : k === "NOSCRIPT" && (u = "", W = true), !V && !v && u && F && (u = H ? H(u, wi(b)) : u.replace(/[\S]/g, "*"));
            const M = x === "strict", S = (L = b.parentElement) == null ? void 0 : L.getAttribute("data-hl-record"), T = x === "default" && Pn(u);
            return (M || T) && !S && !W && k && !(/* @__PURE__ */ new Set(["HEAD", "TITLE", "STYLE", "SCRIPT", "HTML", "BODY", "NOSCRIPT"])).has(k) && u && (u = Yi(u)), { type: ae.Text, textContent: u || "", isStyle: V, rootId: N };
          }(t, { doc: i, needsMask: r, maskTextFn: d, privacySetting: Z, rootId: g });
    ...
    function ot(t, e) {
      const { doc: i, mirror: n, blockClass: s, blockSelector: o, maskTextClass: r, maskTextSelector: a, skipChild: l = false, inlineStylesheet: c = true, maskInputOptions: d = {}, maskTextFn: h, maskInputFn: p, slimDOMOptions: m, dataURLOptions: X = {}, inlineImages: y = false, recordCanvas: G = false, onSerialize: Z, onIframeLoad: g, iframeLoadTimeout: b = 5e3, onStylesheetLoad: I, stylesheetLoadTimeout: R = 5e3, keepIframeSrcFn: L = () => false, newlyAddedElement: F = false, privacySetting: H } = e;
      let { needsMask: x } = e, { preserveWhiteSpace: N = true } = e;
      x || (x = $n(t, r, a, x === void 0));
      const K = gr(t, { doc: i, mirror: n, blockClass: s, blockSelector: o, needsMask: x, inlineStylesheet: c, maskInputOptions: d, maskTextClass: r, maskTextFn: h, maskInputFn: p, dataURLOptions: X, inlineImages: y, recordCanvas: G, keepIframeSrcFn: L, newlyAddedElement: F, privacySetting: H });
      if (!K)
      ...
      if ((u.type === ae.Document || u.type === ae.Element) && V) {
        ...
        if (Hn(t) && (T = Li(t)))
          for (const $ of Array.from(Ti(T))) {
            const A = ot($, S);
            A && (Xt(T) && (A.isShadow = true), u.childNodes.push(A));
          }
      }
      const M = Pt(t);
      return M && St(M) && Xt(M) && (u.isShadow = true), u.type === ae.Element && u.tagName === "iframe" && function(S, T, $) {
    ...
    var Ir = Object.defineProperty, We = (t, e, i) => (((n, s, o) => {
      s in n ? Ir(n, s, { enumerable: true, configurable: true, writable: true, value: o }) : n[s] = o;
    })(t, typeof e != "symbol" ? e + "" : e, i), i);
    class Ui {
      constructor(...e) {
        We(this, "parentElement", null), We(this, "parentNode", null), We(this, "ownerDocument"), We(this, "firstChild", null), We(this, "lastChild", null), We(this, "previousSibling", null), We(this, "nextSibling", null), We(this, "ELEMENT_NODE", 1), We(this, "TEXT_NODE", 3), We(this, "nodeType"), We(this, "nodeName"), We(this, "RRNodeType");
      }
      get childNodes() {
        const e = [];
...
or you can use record.mirror to access the mirror instance during recording.`;
    let os = { map: {}, getId: () => (console.error(at), -1), getNode: () => (console.error(at), null), removeNodeFromMap() {
      console.error(at);
    }, has: () => (console.error(at), false), reset() {
      console.error(at);
    } };
    function Wt(t, e, i = {}) {
      let n = null, s = 0;
      return function(...o) {
        const r = Date.now();
        s || i.leading !== false || (s = r);
        const a = e - (r - s), l = this;
        a <= 0 || a > e ? (n && (clearTimeout(n), n = null), s = r, t.apply(l, o)) : n || i.trailing === false || (n = setTimeout(() => {
          s = i.leading === false ? 0 : Date.now(), n = null, t.apply(l, o);
        }, a));
      };
    }
    ...
    function ct(t, e, i) {
      try {
        ...
        const n = t[e], s = i(n);
        return typeof s == "function" && (s.prototype = s.prototype || {}, Object.defineProperties(s, { __rrweb_original__: { enumerable: false, value: n } })), t[e] = s, () => {
          t[e] = n;
        };
      } catch (n) {
        return () => {
    ...
    function Pi(t) {
      return !!t && (t instanceof Ui && "shadowRoot" in t ? !!t.shadowRoot : !!ft(t));
    }
    class Xr {
      constructor() {
        ...
        C(this, "frozen", false), C(this, "locked", false), C(this, "texts", []), C(this, "attributes", []), C(this, "attributeMap", /* @__PURE__ */ new WeakMap()), C(this, "removes", []), C(this, "mapRemoves", []), C(this, "movedMap", {}), C(this, "addedSet", /* @__PURE__ */ new Set()), C(this, "movedSet", /* @__PURE__ */ new Set()), C(this, "droppedSet", /* @__PURE__ */ new Set()), C(this, "mutationCb"), C(this, "blockClass"), C(this, "blockSelector"), C(this, "maskTextClass"), C(this, "maskTextSelector"), C(this, "inlineStylesheet"), C(this, "maskInputOptions"), C(this, "maskTextFn"), C(this, "maskInputFn"), C(this, "keepIframeSrcFn"), C(this, "recordCanvas"), C(this, "inlineImages"), C(this, "privacySetting"), C(this, "slimDOMOptions"), C(this, "dataURLOptions"), C(this, "doc"), C(this, "mirror"), C(this, "iframeManager"), C(this, "stylesheetManager"), C(this, "shadowDomManager"), C(this, "canvasManager"), C(this, "processedNodeManager"), C(this, "unattachedDoc"), C(this, "processMutations", (e) => {
          ...
          const e = [], i = /* @__PURE__ */ new Set(), n = new Gr(), s = (l) => {
            ...
            const p = ot(l, { doc: this.doc, mirror: this.mirror, blockClass: this.blockClass, blockSelector: this.blockSelector, maskTextClass: this.maskTextClass, maskTextSelector: this.maskTextSelector, skipChild: true, newlyAddedElement: true, inlineStylesheet: this.inlineStylesheet, maskInputOptions: this.maskInputOptions, maskTextFn: this.maskTextFn, maskInputFn: this.maskInputFn, slimDOMOptions: this.slimDOMOptions, dataURLOptions: this.dataURLOptions, recordCanvas: this.recordCanvas, inlineImages: this.inlineImages, privacySetting: this.privacySetting, onSerialize: (m) => {
              us(m, this.mirror) && this.iframeManager.addIframe(m), hs(m, this.mirror) && this.stylesheetManager.trackLinkElement(m), Pi(l) && this.shadowDomManager.addShadowRoot(ft(l), this.doc);
            }, onIframeLoad: (m, X) => {
          ...
          const a = { texts: this.texts.map((l) => {
            ...
            let m = l.value;
            const X = this.privacySetting === "strict", y = this.privacySetting === "default" && Pn(m), G = (d = (c = l.node) == null ? void 0 : c.parentElement) == null ? void 0 : d.getAttribute("data-hl-record");
            return (X || y) && !G && m && (m = Yi(m)), { id: this.mirror.getId(h), value: m };
          ...
          if (!zi(e.target, this.mirror, this.slimDOMOptions))
            switch (e.type) {
              case "characterData": {
                const i = ns(e.target);
                me(e.target, this.blockClass, this.blockSelector, false) || i === e.oldValue || this.texts.push({ value: $n(e.target, this.maskTextClass, this.maskTextSelector, true) && i ? this.maskTextFn ? this.maskTextFn(i, cs(e.target)) : i.replace(/[\S]/g, "*") : i, node: e.target });
                break;
              }
              case "attributes": {
                const i = e.target;
                ...
                if (me(e.target, this.blockClass, this.blockSelector, false) || s === e.oldValue)
                  return;
                ...
                if (o || (o = { node: e.target, attributes: {}, styleDiff: {}, _unchangedStyles: {} }, this.attributes.push(o), this.attributeMap.set(e.target, o)), n === "type" && i.tagName === "INPUT" && (e.oldValue || "").toLowerCase() === "password" && i.setAttribute("data-rr-is-password", "true"), !_n(i.tagName, n)) {
                  ...
                  if (o.attributes[n] = An(this.doc, nt(i.tagName), nt(n), s), n === "style") {
                    ...
                    for (const a of Array.from(r.style))
                      i.style.getPropertyValue(a) === "" && (o.styleDiff[a] = false);
                  }
                }
                break;
              }
              case "childList":
                if (me(e.target, this.blockClass, this.blockSelector, true))
                  return;
                ...
                e.addedNodes.forEach((i) => this.genAdds(i, e.target)), e.removedNodes.forEach((i) => {
                  ...
                  me(e.target, this.blockClass, this.blockSelector, false) || zi(i, this.mirror, this.slimDOMOptions) || !function(o, r) {
                    return r.getId(o) !== -1;
          ...
          if (!this.processedNodeManager.inOtherBuffer(e, this) && !this.addedSet.has(e) && !this.movedSet.has(e)) {
            if (this.mirror.hasNode(e)) {
              ...
              this.movedSet.add(e);
              let n = null;
              i && this.mirror.hasNode(i) && (n = this.mirror.getId(i)), n && n !== -1 && (this.movedMap[Zs(this.mirror.getId(e), n)] = true);
            } else
              this.addedSet.add(e), this.droppedSet.delete(e);
            me(e, this.blockClass, this.blockSelector, false) || (_t(e).forEach((n) => this.genAdds(n)), Pi(e) && _t(ft(e)).forEach((n) => {
    ...
    function Ss(t, e) {
      ...
      return n.observe(e, { attributes: true, attributeOldValue: true, characterData: true, characterDataOldValue: true, childList: true, subtree: true }), n;
    }
    function Wr({ mouseInteractionCb: t, doc: e, mirror: i, blockClass: n, blockSelector: s, sampling: o }) {
      if (o.mouseInteraction === false)
        return () => {
        };
      const r = o.mouseInteraction === true || o.mouseInteraction === void 0 ? {} : o.mouseInteraction, a = [];
      let l = null;
      return Object.keys(Se).filter((c) => Number.isNaN(Number(c)) && !c.endsWith("_Departed") && r[c] !== false).forEach((c) => {
        let d = nt(c);
        const h = /* @__PURE__ */ ((p) => (m) => {
          const X = vt(m);
          if (me(X, n, s, true) || Sr(X))
            return;
          let y = null, G = p;
          if ("pointerType" in m) {
            ...
            y === Me.Touch && (Se[p] === Se.MouseDown ? G = "TouchStart" : Se[p] === Se.MouseUp && (G = "TouchEnd"));
          } else
            Oi(m) && (y = Me.Touch);
          y !== null ? (l = y, (G.startsWith("Touch") && y === Me.Touch || G.startsWith("Mouse") && y === Me.Mouse) && (y = null)) : Se[p] === Se.Click && (y = l, l = null);
          const Z = Oi(m) ? m.changedTouches[0] : m;
          if (!Z)
            return;
          const g = i.getId(X), { clientX: b, clientY: I } = Z;
          _(t)(U({ type: Se[G], id: g, x: b, y: I }, y !== null && { pointerType: y }));
        })(c);
    ...
    function vr(t, e = {}) {
      ...
      let n;
      (function(Z, g) {
        const { mutationCb: b, mousemoveCb: I, mouseInteractionCb: R, scrollCb: L, viewportResizeCb: F, inputCb: H, mediaInteractionCb: x, styleSheetRuleCb: N, styleDeclarationCb: K, canvasMutationCb: k, fontCb: u, selectionCb: V, customElementCb: v } = Z;
        Z.mutationCb = (...W) => {
          g.mutation && g.mutation(...W), b(...W);
        }, Z.mousemoveCb = (...W) => {
          g.mousemove && g.mousemove(...W), I(...W);
        }, Z.mouseInteractionCb = (...W) => {
          g.mouseInteraction && g.mouseInteraction(...W), R(...W);
        }, Z.scrollCb = (...W) => {
          g.scroll && g.scroll(...W), L(...W);
        }, Z.viewportResizeCb = (...W) => {
          g.viewportResize && g.viewportResize(...W), F(...W);
        }, Z.inputCb = (...W) => {
          g.input && g.input(...W), H(...W);
        }, Z.mediaInteractionCb = (...W) => {
          g.mediaInteaction && g.mediaInteaction(...W), x(...W);
        }, Z.styleSheetRuleCb = (...W) => {
          g.styleSheetRule && g.styleSheetRule(...W), N(...W);
        }, Z.styleDeclarationCb = (...W) => {
          g.styleDeclaration && g.styleDeclaration(...W), K(...W);
        }, Z.canvasMutationCb = (...W) => {
          g.canvasMutation && g.canvasMutation(...W), k(...W);
        }, Z.fontCb = (...W) => {
          g.font && g.font(...W), u(...W);
        }, Z.selectionCb = (...W) => {
          g.selection && g.selection(...W), V(...W);
        }, Z.customElementCb = (...W) => {
          g.customElement && g.customElement(...W), v(...W);
        };
      })(t, e), t.recordDOM && (n = Ss(t, t.doc));
      const s = function({ mousemoveCb: Z, sampling: g, doc: b, mirror: I }) {
        if (g.mousemove === false)
          return () => {
          };
        ...
        const x = Wt(_((k) => {
          const u = Date.now() - F;
          Z(H.map((V) => (V.timeOffset -= u, V)), k), H = [], F = null;
        }), L), N = _(Wt(_((k) => {
          const u = vt(k), { clientX: V, clientY: v } = Oi(k) ? k.changedTouches[0] : k;
          F || (F = ei()), H.push({ x: V, y: v, id: I.getId(u), timeOffset: ei() - F }), x(typeof DragEvent != "undefined" && k instanceof DragEvent ? j.Drag : k instanceof MouseEvent ? j.MouseMove : j.TouchMove);
        }), R, { trailing: false })), K = [Ze("mousemove", N, b), Ze("touchmove", N, b), Ze("drag", N, b)];
        return _(() => {
          K.forEach((k) => k());
        });
      }(t), o = Wr(t), r = Xs(t), a = function({ viewportResizeCb: Z }, { win: g }) {
        let b = -1, I = -1;
        return Ze("resize", _(Wt(_(() => {
          const R = ls(), L = as();
          b === R && I === L || (Z({ width: Number(L), height: Number(R) }), b = R, I = L);
        }), 200)), g);
      }(t, { win: i }), l = function({ inputCb: Z, doc: g, mirror: b, blockClass: I, blockSelector: R, ignoreClass: L, ignoreSelector: F, maskInputOptions: H, maskInputFn: x, sampling: N, userTriggeredOnInput: K }) {
        function k(S) {
          let T = vt(S);
          const $ = S.isTrusted, A = T && T.tagName;
          if (T && A === "OPTION" && (T = qt(T)), !T || !A || Rr.indexOf(A) < 0 || me(T, I, R, true) || T.classList.contains(L) || F && T.matches(F))
            return;
          let B = T.value, z = false;
          ...
          Ie === "radio" && J && z && g.querySelectorAll(`input[type="radio"][name="${J}"]`).forEach((P) => {
            if (P !== T) {
              const ue = P.value;
              u(P, K ? { text: ue, isChecked: !z, userTriggered: false } : { text: ue, isChecked: !z });
            }
          });
        }
        function u(S, T) {
        ...
        const V = (N.input === "last" ? ["change"] : ["input", "change"]).map((S) => Ze(S, _(k), g)), v = g.defaultView;
        if (!v)
          return () => {
            V.forEach((S) => S());
          };
        const W = v.Object.getOwnPropertyDescriptor(v.HTMLInputElement.prototype, "value"), M = [[v.HTMLInputElement.prototype, "value"], [v.HTMLInputElement.prototype, "checked"], [v.HTMLSelectElement.prototype, "value"], [v.HTMLTextAreaElement.prototype, "value"], [v.HTMLSelectElement.prototype, "selectedIndex"], [v.HTMLOptionElement.prototype, "selected"]];
        return W && W.set && V.push(...M.map((S) => $t(S[0], S[1], { set() {
          _(k)({ target: this, isTrusted: false });
        } }, false, v))), _(() => {
          V.forEach((S) => S());
        });
      }(t), c = function({ mediaInteractionCb: Z, blockClass: g, blockSelector: b, mirror: I, sampling: R, doc: L }) {
        const F = _((x) => Wt(_((N) => {
          const K = vt(N);
          if (!K || me(K, g, b, true))
            return;
          const { currentTime: k, volume: u, muted: V, playbackRate: v, loop: W } = K;
          Z({ type: x, id: I.getId(K), currentTime: k, volume: u, muted: V, playbackRate: v, loop: W });
      ...
      t.recordDOM && (d = function({ styleSheetRuleCb: Z, mirror: g, stylesheetManager: b }, { win: I }) {
        ...
        I.CSSStyleSheet.prototype.insertRule = new Proxy(R, { apply: _((K, k, u) => {
          const [V, v] = u, { id: W, styleId: M } = ze(k, g, b.styleMirror);
          return (W && W !== -1 || M && M !== -1) && Z({ id: W, styleId: M, adds: [{ rule: V, index: v }] }), K.apply(k, u);
        }) });
        const L = I.CSSStyleSheet.prototype.deleteRule;
        let F, H;
        I.CSSStyleSheet.prototype.deleteRule = new Proxy(L, { apply: _((K, k, u) => {
          const [V] = u, { id: v, styleId: W } = ze(k, g, b.styleMirror);
          return (v && v !== -1 || W && W !== -1) && Z({ id: v, styleId: W, removes: [{ index: V }] }), K.apply(k, u);
          ...
          const [V] = u, { id: v, styleId: W } = ze(k, g, b.styleMirror);
          return (v && v !== -1 || W && W !== -1) && Z({ id: v, styleId: W, replace: V }), K.apply(k, u);
          ...
          const [V] = u, { id: v, styleId: W } = ze(k, g, b.styleMirror);
          return (v && v !== -1 || W && W !== -1) && Z({ id: v, styleId: W, replaceSync: V }), K.apply(k, u);
        }) }));
        const x = {};
        ...
        return Object.entries(x).forEach(([K, k]) => {
          N[K] = { insertRule: k.prototype.insertRule, deleteRule: k.prototype.deleteRule }, k.prototype.insertRule = new Proxy(N[K].insertRule, { apply: _((u, V, v) => {
            const [W, M] = v, { id: S, styleId: T } = ze(V.parentStyleSheet, g, b.styleMirror);
            return (S && S !== -1 || T && T !== -1) && Z({ id: S, styleId: T, adds: [{ rule: W, index: [...ti(V), M || 0] }] }), u.apply(V, v);
          }) }), k.prototype.deleteRule = new Proxy(N[K].deleteRule, { apply: _((u, V, v) => {
            const [W] = v, { id: M, styleId: S } = ze(V.parentStyleSheet, g, b.styleMirror);
            return (M && M !== -1 || S && S !== -1) && Z({ id: M, styleId: S, removes: [{ index: [...ti(V), W] }] }), u.apply(V, v);
          }) });
        }), _(() => {
      ...
      }(t, { win: i }), h = Gs(t, t.doc), p = function({ styleDeclarationCb: Z, mirror: g, ignoreCSSAttributes: b, stylesheetManager: I }, { win: R }) {
        const L = R.CSSStyleDeclaration.prototype.setProperty;
        R.CSSStyleDeclaration.prototype.setProperty = new Proxy(L, { apply: _((H, x, N) => {
          var K;
          const [k, u, V] = N;
          if (b.has(k))
            return L.apply(x, [k, u, V]);
          const { id: v, styleId: W } = ze((K = x.parentRule) == null ? void 0 : K.parentStyleSheet, g, I.styleMirror);
          return (v && v !== -1 || W && W !== -1) && Z({ id: v, styleId: W, set: { property: k, value: u, priority: V }, index: ti(x.parentRule) }), H.apply(x, N);
        }) });
        ...
        return R.CSSStyleDeclaration.prototype.removeProperty = new Proxy(F, { apply: _((H, x, N) => {
          ...
          if (b.has(k))
            return F.apply(x, [k]);
          const { id: u, styleId: V } = ze((K = x.parentRule) == null ? void 0 : K.parentStyleSheet, g, I.styleMirror);
          return (u && u !== -1 || V && V !== -1) && Z({ id: u, styleId: V, remove: { property: k }, index: ti(x.parentRule) }), H.apply(x, N);
        }) }), _(() => {
          R.CSSStyleDeclaration.prototype.setProperty = L, R.CSSStyleDeclaration.prototype.removeProperty = F;
        });
      }(t, { win: i }), t.collectFonts && (m = function({ fontCb: Z, doc: g }) {
      ...
      const X = function(Z) {
        const { doc: g, mirror: b, blockClass: I, blockSelector: R, selectionCb: L } = Z;
        let F = true;
        const H = _(() => {
          const x = g.getSelection();
          if (!x || F && (x != null && x.isCollapsed))
            return;
          F = x.isCollapsed || false;
          const N = [], K = x.rangeCount || 0;
          for (let k = 0; k < K; k++) {
            const u = x.getRangeAt(k), { startContainer: V, startOffset: v, endContainer: W, endOffset: M } = u;
            me(V, I, R, true) || me(W, I, R, true) || N.push({ start: b.getId(V), startOffset: v, end: b.getId(W), endOffset: M });
          }
          L({ ranges: N });
        });
        return H(), Ze("selectionchange", H);
      }(t), y = function({ doc: Z, customElementCb: g }) {
        const b = Z.defaultView;
      ...
      for (const Z of t.plugins)
        G.push(Z.observer(Z.callback, i, Z.options));
      return _(() => {
        De.forEach((Z) => Z.reset()), n == null || n.disconnect(), s(), o(), r(), a(), l(), c(), d(), h(), p(), m(), X(), y(), G.forEach((Z) => Z());
      });
    }
    function ii(t) {
    ...
    class Cr {
      ...
      attachIframe(e, i) {
        var n, s;
        this.mutationCb({ adds: [{ parentId: this.mirror.getId(e), nextId: null, node: i }], removes: [], texts: [], attributes: [], isAttachIframe: true }), this.recordCrossOriginIframes && ((n = e.contentWindow) == null || n.addEventListener("message", this.handleMessage.bind(this))), (s = this.loadListener) == null || s.call(this, e), e.contentDocument && e.contentDocument.adoptedStyleSheets && e.contentDocument.adoptedStyleSheets.length > 0 && this.stylesheetManager.adoptStyleSheets(e.contentDocument.adoptedStyleSheets, this.mirror.getId(e.contentDocument));
      }
      handleMessage(e) {
        const i = e;
      ...
      transformCrossOriginEvent(e, i) {
        ...
        switch (i.type) {
          case q.FullSnapshot: {
            ...
            return this.crossOriginIframeRootIdMap.set(e, s), this.patchRootIdOnNode(i.data.node, s), { timestamp: i.timestamp, type: q.IncrementalSnapshot, data: { source: j.Mutation, adds: [{ parentId: this.mirror.getId(e), nextId: null, node: i.data.node }], removes: [], texts: [], attributes: [], isAttachIframe: true } };
          }
          case q.Meta:
          case q.Load:
    ...
    class kr {
      ...
      patchAttachShadow(e, i) {
        ...
        this.restoreHandlers.push(ct(e.prototype, "attachShadow", function(s) {
          return function(o) {
            const r = s.call(this, o), a = ft(this);
    ...
    const Ws = /* @__PURE__ */ new Map(), Rs = (t, e, i) => {
      if (!t || !Cs(t, e) && typeof t != "object")
        return;
      const n = function(o, r) {
        let a = Ws.get(o);
        return a || (a = /* @__PURE__ */ new Map(), Ws.set(o, a)), a.has(r) || a.set(r, []), a.get(r);
            ...
            if (!me(this, e, i, true)) {
              ...
              if ("__context" in this || (this.__context = c), n && ["webgl", "webgl2"].includes(c))
                if (l[0] && typeof l[0] == "object") {
                  const d = l[0];
                  d.preserveDrawingBuffer || (d.preserveDrawingBuffer = true);
                } else
          ...
          try {
            ...
            const c = ct(t, l, function(d) {
              return function(...h) {
                ...
                if (Rs(p, o, this), "tagName" in this.canvas && !me(this.canvas, n, s, true)) {
            ...
            const d = $t(t, l, { set(h) {
              i(this.canvas, { type: e, property: l, args: [h], setter: true });
            } });
            r.push(d);
          }
      return r;
    ...
    class Nr {
      constructor(e) {
        ...
        this.mutationCb = e.mutationCb, this.mirror = e.mirror, this.logger = e.logger, this.worker = new wr(), this.worker.onmessage = (d) => {
          const { id: h } = d.data;
          if (this.snapshotInProgressMap.set(h, false), !("base64" in d.data))
            return void this.debug(null, "canvas worker received empty message", { data: d.data, status: d.data.status });
          const { base64: p, type: m, dx: X, dy: y, dw: G, dh: Z } = d.data, g = { id: h, type: dt["2D"], commands: [{ property: "clearRect", args: [X, y, G, Z] }, { property: "drawImage", args: [{ rr_type: "ImageBitmap", args: [{ rr_type: "Blob", data: [{ rr_type: "ArrayBuffer", base64: p }], type: m }] }, X, y, G, Z] }] };
        ...
        return ne(this, null, function* () {
          ...
          if (!(o && (/* @__PURE__ */ new Date()).getTime() - o < s))
            if (this.debug(e, "starting snapshotting"), e.width !== 0 && e.height !== 0) {
              this.lastSnapshotTime.set(n, (/* @__PURE__ */ new Date()).getTime()), this.snapshotInProgressMap.set(n, true);
              try {
                if (this.options.clearWebGLBuffer !== false && ["webgl", "webgl2"].includes(e.__context)) {
                  const d = e.getContext(e.__context);
                  ((i = d == null ? void 0 : d.getContextAttributes()) == null ? void 0 : i.preserveDrawingBuffer) === false && (d.clear(d.COLOR_BUFFER_BIT), this.debug(e, "cleared webgl canvas to load it into memory", { attributes: d == null ? void 0 : d.getContextAttributes() }));
                }
                ...
                this.snapshotInProgressMap.set(n, false);
              }
            } else
      ...
      initCanvasFPSObserver(e, i, n, s, o, r, a, l) {
        const c = ks(n, s, o, true), d = 1e3 / i;
        let h, p = 0;
        const m = /* @__PURE__ */ new Map(), X = (Z) => {
          const g = [];
          ...
          return e && n.document.querySelectorAll("video").forEach((b) => {
            if ((b.src === "" || b.src.indexOf("blob:") !== -1) && !me(b, s, o, true)) {
              g.push(b);
              const I = this.mirror.getId(b);
              m.has(I) || m.set(I, Z);
            }
          }), g;
        }, G = (Z) => ne(this, null, function* () {
          if (p && Z - p < d)
            return void (h = requestAnimationFrame(G));
          p = Z;
          const g = (I) => {
            const R = this.mirror.getId(I), L = m.get(R), F = !r.initialSnapshotDelay || Z - L > r.initialSnapshotDelay;
            return this.debug(I, { delay: r.initialSnapshotDelay, delta: Z - L, hadLoadingTime: F }), F;
          }, b = [];
          b.push(...X(Z).filter(g).map((I) => this.snapshot(I))), b.push(...y(Z).filter(g).map((I) => ne(this, null, function* () {
            ...
            if (this.snapshotInProgressMap.get(R))
              ...
              this.snapshotInProgressMap.set(R, true);
              try {
                ...
                let K = a || 1;
                l && (K = Math.min(K, l / N));
                const k = H * K, u = x * K, V = yield createImageBitmap(I, { resizeWidth: k, resizeHeight: u }), v = Math.max(L, F) / N, W = H * v, M = x * v, S = (L - W) / 2, T = (F - M) / 2;
                this.debug(I, "created image bitmap", { actualWidth: H, actualHeight: x, boxWidth: L, boxHeight: F, outputWidth: W, outputHeight: M, resizeWidth: k, resizeHeight: u, scale: K, outputScale: v, offsetX: S, offsetY: T }), this.worker.postMessage({ id: R, bitmap: V, width: k, height: u, dx: S, dy: T, dw: W, dh: M, dataURLOptions: r.dataURLOptions, logDebug: !!this.logger }, [V]), this.debug(I, "send message");
              } catch (L) {
                this.debug(I, "failed to snapshot", L);
              } finally {
                this.snapshotInProgressMap.set(R, false);
              }
            }
          }))), yield Promise.all(b).catch(console.error), h = requestAnimationFrame(G);
        });
        h = requestAnimationFrame(G), this.resetObservers = () => {
          c(), h && cancelAnimationFrame(h);
        };
      }
      initCanvasMutationObserver(e, i, n) {
        this.startRAFTimestamping(), this.startPendingCanvasMutationFlusher();
        const s = ks(e, i, n, false), o = function(a, l, c, d) {
          ...
          for (const m of p)
            try {
              if (typeof l.CanvasRenderingContext2D.prototype[m] != "function")
                continue;
              const X = ct(l.CanvasRenderingContext2D.prototype, m, function(y) {
                return function(...G) {
                  return me(this.canvas, c, d, true) || setTimeout(() => {
                    const Z = vs(G, l, this);
                    a(this.canvas, { type: dt["2D"], property: m, args: Z });
                  }, 0), y.apply(this, G);
                };
              });
              h.push(X);
            } catch (X) {
              const y = $t(l.CanvasRenderingContext2D.prototype, m, { set(G) {
                a(this.canvas, { type: dt["2D"], property: m, args: [G], setter: true });
              } });
              h.push(y);
            }
          return () => {
    ...
    class xr {
      constructor() {
        C(this, "nodeMap", /* @__PURE__ */ new WeakMap()), C(this, "active", false);
      }
      inOtherBuffer(e, i) {
    ...
    function Fe(t = {}) {
      var e, i, n, s, o, r, a, l;
      const { emit: c, checkoutEveryNms: d, checkoutEveryNth: h, blockClass: p = "highlight-block", blockSelector: m = null, ignoreClass: X = "highlight-ignore", ignoreSelector: y = null, maskTextClass: G = "highlight-mask", maskTextSelector: Z = null, inlineStylesheet: g = true, maskAllInputs: b, maskInputOptions: I, slimDOMOptions: R, maskInputFn: L, maskTextFn: F = Yi, hooks: H, packFn: x, sampling: N = {}, mousemoveWait: K, recordDOM: k = true, recordCanvas: u = false, recordCrossOriginIframes: V = false, recordAfter: v = t.recordAfter === "DOMContentLoaded" ? t.recordAfter : "load", userTriggeredOnInput: W = false, collectFonts: M = false, inlineImages: S = false, plugins: T, keepIframeSrcFn: $ = () => false, privacySetting: A = "default", ignoreCSSAttributes: B = /* @__PURE__ */ new Set([]), errorHandler: z, logger: Ie } = t, be = U(U({}, t.dataURLOptions), (i = (e = t.sampling) == null ? void 0 : e.canvas) == null ? void 0 : i.dataURLOptions);
      Rt = z;
      const J = !V || window.parent === window;
      let P = false;
      if (!J)
        try {
      ...
      const ue = b === true ? { color: true, date: true, "datetime-local": true, email: true, month: true, number: true, range: true, search: true, tel: true, text: true, time: true, url: true, week: true, textarea: true, select: true, password: true } : I !== void 0 ? I : { password: true }, pe = R === true || R === "all" ? { script: true, comment: true, headFavicon: true, headWhitespace: true, headMetaSocial: true, headMetaRobots: true, headMetaHttpEquiv: true, headMetaVerification: true, headMetaAuthorship: R === "all", headMetaDescKeywords: R === "all", headTitleMutations: R === "all" } : R || {};
      let Pe;
      (function(D = window) {
      ...
      oe = (D, Le) => {
        ...
        if (se.timestamp = ei(), !((ie = De[0]) != null && ie.isFrozen()) || se.type === q.FullSnapshot || se.type === q.IncrementalSnapshot && se.data.source === j.Mutation || De.forEach((ke) => ke.unfreeze()), J)
          ...
          const ke = { type: "rrweb", event: fi(se), origin: window.location.origin, isCheckout: Le };
      ...
      }, nr = (D) => oe({ type: q.IncrementalSnapshot, data: U({ source: j.Scroll }, D) }), sr = (D) => oe({ type: q.IncrementalSnapshot, data: U({ source: j.CanvasMutation }, D) }), et = new Lr({ mutationCb: Wi, adoptedStyleSheetCb: (D) => oe({ type: q.IncrementalSnapshot, data: U({ source: j.AdoptedStyleSheet }, D) }) }), tt = new Cr({ mirror: Te, mutationCb: Wi, stylesheetManager: et, recordCrossOriginIframes: V, wrappedEmit: oe });
      for (const D of T || [])
      ...
      const Ri = new kr({ mutationCb: Wi, scrollCb: nr, bypassOptions: { blockClass: p, blockSelector: m, maskTextClass: G, maskTextSelector: Z, inlineStylesheet: g, maskInputOptions: ue, dataURLOptions: be, maskTextFn: F, maskInputFn: L, recordCanvas: u, inlineImages: S, privacySetting: A, sampling: N, slimDOMOptions: pe, iframeManager: tt, stylesheetManager: et, canvasManager: kt, keepIframeSrcFn: $, processedNodeManager: Tn }, mirror: Te });
      ri = (D = false) => {
        if (!k)
          return;
        ...
        const Le = function(ie, se) {
          const { mirror: ke = new Mn(), blockClass: ee = "highlight-block", blockSelector: Ht = null, maskTextClass: Va = "highlight-mask", maskTextSelector: Ga = null, inlineStylesheet: fa = true, inlineImages: Wa = false, recordCanvas: Ra = false, maskAllInputs: wn = false, maskTextFn: va, maskInputFn: Ca, slimDOM: vi = false, dataURLOptions: ka, preserveWhiteSpace: Ta, onSerialize: wa, onIframeLoad: Na, iframeLoadTimeout: La, onStylesheetLoad: xa, stylesheetLoadTimeout: Ja, keepIframeSrcFn: Ya = () => false, privacySetting: Ka = "default" } = se || {};
          return ot(ie, { doc: ie, mirror: ke, blockClass: ee, blockSelector: Ht, maskTextClass: Va, maskTextSelector: Ga, skipChild: false, inlineStylesheet: fa, maskInputOptions: wn === true ? { color: true, date: true, "datetime-local": true, email: true, month: true, number: true, range: true, search: true, tel: true, text: true, time: true, url: true, week: true, textarea: true, select: true, password: true } : wn === false ? { password: true } : wn, maskTextFn: va, maskInputFn: Ca, slimDOMOptions: vi || vi === "all" ? { script: true, comment: true, headFavicon: true, headWhitespace: true, headMetaDescKeywords: vi === "all", headMetaSocial: true, headMetaRobots: true, headMetaHttpEquiv: true, headMetaAuthorship: true, headMetaVerification: true } : vi || {}, dataURLOptions: ka, inlineImages: Wa, recordCanvas: Ra, preserveWhiteSpace: Ta, onSerialize: wa, onIframeLoad: Na, iframeLoadTimeout: La, onStylesheetLoad: xa, stylesheetLoadTimeout: Ja, keepIframeSrcFn: Ya, newlyAddedElement: false, privacySetting: Ka });
        }(document, { mirror: Te, blockClass: p, blockSelector: m, maskTextClass: G, maskTextSelector: Z, inlineStylesheet: g, maskAllInputs: ue, maskTextFn: F, maskInputFn: L, slimDOM: pe, dataURLOptions: be, recordCanvas: u, inlineImages: S, privacySetting: A, onSerialize: (ie) => {
          us(ie, Te) && tt.addIframe(ie), hs(ie, Te) && et.trackLinkElement(ie), Pi(ie) && Ri.addShadowRoot(ft(ie), document);
        }, onIframeLoad: (ie, se) => {
      ...
      try {
        ...
        return document.readyState === "interactive" || document.readyState === "complete" ? ie() : (D.push(Ze("DOMContentLoaded", () => {
          ...
          D.forEach((se) => se()), Tn.destroy(), li = false, Rt = void 0;
        };
      } catch (D) {
        console.warn(D);
      }
    ...
    function Qi(t, e) {
      ...
      return JSON.stringify(t, function(o, r) {
        ...
        if (r == null)
          return r;
        if (function(a) {
          return Di(a) && Object.keys(a).length > i.numOfKeysLimit || typeof a == "function" ? true : a instanceof Event && a.isTrusted === false ? Object.keys(a).length === 1 : !!(Di(a) && Ks(a, i.depthOfLimit));
        }(r))
          return function(a) {
            let l = a.toString();
    ...
    var Ur = typeof globalThis != "undefined" ? globalThis : typeof window != "undefined" ? window : typeof he != "undefined" ? he : typeof self != "undefined" ? self : {};
    function ji(t) {
    ...
    function Fr() {
      return Us || (Us = 1, Ms.exports = function() {
        ...
        c.prototype = { getArgs: function() {
          ...
          var m = this.getFileName() || "", X = this.getLineNumber() || "", y = this.getColumnNumber() || "", G = this.getFunctionName() || "";
          return this.getIsEval() ? m ? "[eval] (" + m + ":" + X + ":" + y + ")" : "[eval]:" + X + ":" + y : G ? G + " (" + m + ":" + X + ":" + y + ")" : m + ":" + X + ":" + y;
        } }, c.fromString = function(m) {
          var X = m.indexOf("("), y = m.lastIndexOf(")"), G = m.substring(0, X), Z = m.substring(X + 1, y).split(","), g = m.substring(y + 1);
          if (g.indexOf("@") === 0)
            var b = /@(.+?)(?::(\d+))?(?::(\d+))?$/.exec(g, ""), I = b[1], R = b[2], L = b[3];
          return new c({ functionName: G, args: Z || void 0, fileName: I, lineNumber: R || void 0, columnNumber: L || void 0 });
        };
...
`).filter(function(e) {
      ...
      function o(r, a) {
        return r[a] ? function(l, c, d) {
          try {
            ...
            const h = l[c], p = d(h);
            return typeof p == "function" && (p.prototype = p.prototype || {}, Object.defineProperties(p, { __rrweb_original__: { enumerable: false, value: h } })), l[c] = p, () => {
              l[c] = h;
            };
          } catch (h) {
            return () => {
    ...
    var jr = { REACT_APP_COMMIT_SHA: "7e6f483f79dd1bb79a01e572dac9885e69c8234d", BASE_URL: "/", MODE: "production", DEV: false, PROD: true, SSR: false };
    const As = "X-Highlight-Request", _s = (t) => {
      let e = t;
      ...
      return r.sort((a, l) => a.fetchStart - l.fetchStart).reduce((a, l) => {
        ...
        return c && (c = ((d, { headersToRedact: h, headersToRecord: p, requestResponseSanitizer: m }) => {
          ...
          if (m) {
            let R = true;
            try {
              G.request.body = JSON.parse(G.request.body);
            } catch (F) {
              R = false;
            }
            let L = true;
            try {
              G.response.body = JSON.parse(G.response.body);
            } catch (F) {
              L = false;
            }
            try {
              ...
              R = R && !!((X = G == null ? void 0 : G.request) != null && X.body), L = L && !!((y = G == null ? void 0 : G.response) != null && y.body), R && (G.request.body = JSON.stringify(G.request.body)), L && (G.response.body = JSON.stringify(G.response.body));
            }
            if (!G)
              return null;
          }
          const Z = G, { request: g, response: b } = Z, I = Ue(Z, ["request", "response"]);
      ...
      return s = e, !((n = t).toLocaleLowerCase().includes((o = jr.REACT_APP_PUBLIC_GRAPH_URI) != null ? o : "highlight.io") || n.toLocaleLowerCase().includes("highlight.io") || n.toLocaleLowerCase().includes(s)) || sn(t, i);
      var n, s, o;
    }, sn = (t, e) => {
      var i;
      let n = [];
      e === true ? (n = ["localhost", /^\//], (i = window == null ? void 0 : window.location) != null && i.host && n.push(window.location.host)) : e instanceof Array && (n = e);
      let s = false;
      return n.forEach((o) => {
        t.match(o) && (s = true);
      }), s;
    ...
    const $s = () => {
      return [(t = Xe(ce.SESSION_SECURE_ID)) != null ? t : "", Ar(10)];
      var t;
    }, eo = (t, e) => t + "/" + e, _r = (t, e, i, n, s, o) => {
      ...
      return r.open = function(d, h) {
        ...
        if (m && d) {
          const y = to(d, X.url);
          y && (this._body = y, X.body = _e(y, s, o, X.headers));
        }
        return this.addEventListener("load", function() {
          return ne(this, null, function* () {
            const y = { status: this.status, headers: {}, body: void 0 };
            if (m) {
              const G = this.getAllResponseHeaders().trim().split(/[\r\n]+/), Z = {};
              if (G.forEach(function(g) {
                const b = g.split(": "), I = b.shift();
                Z[I] = b.join(": ");
              }), y.headers = Z, d) {
                const g = to(d, X.url);
                g && (X.body = _e(g, s, o, y.headers));
              }
              if (this.responseType === "" || this.responseType === "text")
                y.body = _e(this.responseText, s, o, y.headers), y.size = 8 * this.responseText.length;
              else if (this.responseType === "blob") {
                if (this.response instanceof Blob)
                  try {
                    const g = yield this.response.text();
                    y.body = _e(g, s, o, y.headers), y.size = this.response.size;
                  } catch (g) {
                  }
              } else
                try {
                  y.body = _e(this.response, s, o, y.headers);
                } catch (g) {
                }
            }
            t({ request: X, response: y, urlBlocked: !m });
          });
        }), this.addEventListener("error", function() {
          return ne(this, null, function* () {
            const y = { status: this.status, headers: void 0, body: void 0 };
            t({ request: X, response: y, urlBlocked: false });
          });
      ...
      if (typeof t == "string") {
        ...
        return je(t);
      return null;
    }, qr = { "application/json": 67108864, "text/plain": 67108864 }, _e = (t, e, i, n) => {
      var s, o, r;
      let a = 65536;
      if (n) {
        let l = "";
      ...
      return window._fetchProxy = function(a, l) {
        const { method: c, url: d } = el(a, l);
        if (!nn(d, e, i))
          return r.call(this, a, l);
        const [h, p] = $s();
        if (sn(d, i)) {
          l = l || {};
          let G = new Headers(l.headers);
          a instanceof Request && [...a.headers].forEach(([Z, g]) => G.set(Z, g)), G.set(As, eo(h, p)), l.headers = Object.fromEntries(G.entries());
        }
        const m = { sessionSecureID: h, id: p, headers: {}, body: void 0, url: d, verb: c }, X = !n.some((G) => d.toLowerCase().includes(G));
        ...
        let y = r.call(this, a, l);
        return tl(y, m, t, X, s, o), y;
      }, () => {
      ...
      t.then((r) => ne(this, null, function* () {
        let a = { body: void 0, headers: void 0, status: 0, size: 0 }, l = false, c = !n;
        "stack" in r || r instanceof Error ? (a = Ve(U({}, a), { body: r.message, status: 0, size: void 0 }), l = true) : "status" in r && (a = Ve(U({}, a), { status: r.status }), n && (a.body = yield il(r, o, s), a.headers = Object.fromEntries(r.headers.entries()), a.size = 8 * a.body.length), r.type !== "opaque" && r.type !== "opaqueredirect" || (c = true, a = Ve(U({}, a), { body: "CORS blocked request" })), l = true), l && i({ request: e, response: a, urlBlocked: c });
      })).catch(() => {
      });
    }, il = (t, e, i) => ne(this, null, function* () {
      let n;
      try {
      ...
      return n;
    }), nl = ({ xhrCallback: t, fetchCallback: e, webSocketRequestCallback: i, webSocketEventCallback: n, disableWebSocketRecording: s, bodyKeysToRedact: o, backendUrl: r, tracingOrigins: a, urlBlocklist: l, sessionSecureID: c, bodyKeysToRecord: d }) => {
      const h = _r(t, r, a, l, o, d), p = $r(e, r, a, l, o, d), m = s ? () => {
      } : ((X, y, G) => {
        const Z = window._highlightWebSocketRequestCallback;
        ...
        return window._highlightWebSocketEventCallback = (b) => {
          const I = b, R = Ue(I, ["message", "size"]), L = G.some((F) => b.name.toLowerCase().includes(F));
          y(L ? R : b);
        }, () => {
          window._highlightWebSocketRequestCallback = Z, window._highlightWebSocketEventCallback = g;
        };
      })(i, n, l);
      return () => {
        h(), p(), m();
    ...
    class He {
      ...
      startListening() {
        ...
        }, { enablePromisePatch: this.enablePromisePatch })), this.options.enableOtelTracing && Promise.resolve().then(() => Xa).then(({ shutdown: i }) => {
      ...
      static setupNetworkListener(e, i) {
        ...
        e._backendUrl = (i == null ? void 0 : i.backendUrl) || sl.REACT_APP_PUBLIC_GRAPH_URI || "https://pub.highlight.run", e.xhrNetworkContents = [], e.fetchNetworkContents = [], e.webSocketNetworkContents = [], e.webSocketEventContents = [], e.networkHeadersToRedact = [], e.urlBlocklist = [], e.tracingOrigins = i.tracingOrigins || [], (i == null ? void 0 : i.disableNetworkRecording) !== void 0 ? (e.disableNetworkRecording = i == null ? void 0 : i.disableNetworkRecording, e.enableRecordingNetworkContents = false, e.disableRecordingWebSocketContents = true, e.networkHeadersToRedact = [], e.networkBodyKeysToRedact = [], e.urlBlocklist = [], e.networkBodyKeysToRecord = [], e.networkBodyKeysToRecord = []) : typeof (i == null ? void 0 : i.networkRecording) == "boolean" ? (e.disableNetworkRecording = !i.networkRecording, e.enableRecordingNetworkContents = false, e.disableRecordingWebSocketContents = true, e.networkHeadersToRedact = [], e.networkBodyKeysToRedact = [], e.urlBlocklist = []) : (((n = i.networkRecording) == null ? void 0 : n.enabled) !== void 0 ? e.disableNetworkRecording = !i.networkRecording.enabled : e.disableNetworkRecording = false, e.enableRecordingNetworkContents = ((s = i.networkRecording) == null ? void 0 : s.recordHeadersAndBody) || false, e.disableRecordingWebSocketContents = ((o = i.networkRecording) == null ? void 0 : o.disableWebSocketEventRecordings) || false, e.networkHeadersToRedact = ((a = (r = i.networkRecording) == null ? void 0 : r.networkHeadersToRedact) == null ? void 0 : a.map((y) => y.toLowerCase())) || [], e.networkBodyKeysToRedact = ((c = (l = i.networkRecording) == null ? void 0 : l.networkBodyKeysToRedact) == null ? void 0 : c.map((y) => y.toLowerCase())) || [], e.urlBlocklist = ((h = (d = i.networkRecording) == null ? void 0 : d.urlBlocklist) == null ? void 0 : h.map((y) => y.toLowerCase())) || [], e.urlBlocklist = [...e.urlBlocklist, ...Br], e.requestResponseSanitizer = (p = i.networkRecording) == null ? void 0 : p.requestResponseSanitizer, e.networkHeaderKeysToRecord = (m = i.networkRecording) == null ? void 0 : m.headerKeysToRecord, e.networkHeaderKeysToRecord && (e.networkHeadersToRedact = [], e.networkHeaderKeysToRecord = e.networkHeaderKeysToRecord.map((y) => y.toLocaleLowerCase())), e.networkBodyKeysToRecord = (X = i.networkRecording) == null ? void 0 : X.bodyKeysToRecord, e.networkBodyKeysToRecord && (e.networkBodyKeysToRedact = [], e.networkBodyKeysToRecord = e.networkBodyKeysToRecord.map((y) => y.toLocaleLowerCase()))), !e.disableNetworkRecording && e.enableRecordingNetworkContents && e.listeners.push(nl({ xhrCallback: (y) => {
          e.xhrNetworkContents.push(y);
        }, fetchCallback: (y) => {
          e.fetchNetworkContents.push(y);
        }, webSocketRequestCallback: (y) => {
          e.webSocketNetworkContents && e.webSocketNetworkContents.push(y);
        }, webSocketEventCallback: (y) => {
          e.webSocketEventContents.push(y);
    ...
    function rn(t, e) {
      let i = 0, n = 1;
      for (const s of t.body.matchAll(ll)) {
        if (typeof s.index == "number" || rl(false), s.index >= e)
          break;
...
`, d = n.split(/\r\n|[\n\r]/g), h = d[s];
      if (h.length > 120) {
        ...
        return c + no([[`${r} |`, X[0]], ...X.slice(1, p + 1).map((y) => ["|", y]), ["|", "^".padStart(m)], ["|", X[p + 1]]]);
      }
...
`);
    ...
    class ln extends Error {
      constructor(e, ...i) {
        var n, s, o;
        const { nodes: r, source: a, positions: l, path: c, originalError: d, extensions: h } = function(y) {
          const G = y[0];
          return G == null || "kind" in G || "length" in G ? { nodes: G, source: y[1], positions: y[2], path: y[3], originalError: y[4], extensions: y[5] } : G;
        }(i);
        ...
        const p = so((n = this.nodes) === null || n === void 0 ? void 0 : n.map((y) => y.loc).filter((y) => y != null));
        this.source = a != null ? a : p == null || (s = p[0]) === null || s === void 0 ? void 0 : s.source, this.positions = l != null ? l : p == null ? void 0 : p.map((y) => y.start), this.locations = l && a ? l.map((y) => rn(a, y)) : p == null ? void 0 : p.map((y) => rn(y.source, y.start));
        const m = typeof (X = d == null ? void 0 : d.extensions) == "object" && X !== null ? d == null ? void 0 : d.extensions : void 0;
        var X;
        this.extensions = (o = h != null ? h : m) !== null && o !== void 0 ? o : /* @__PURE__ */ Object.create(null), Object.defineProperties(this, { message: { writable: true, enumerable: true }, name: { enumerable: false }, nodes: { enumerable: false }, source: { enumerable: false }, positions: { enumerable: false }, originalError: { enumerable: false } }), d != null && d.stack ? Object.defineProperty(this, "stack", { value: d.stack, writable: true, configurable: true }) : Error.captureStackTrace ? Error.captureStackTrace(this, ln) : Object.defineProperty(this, "stack", { value: Error().stack, writable: true, configurable: true });
      }
...
` + io(this.source, n);
      ...
      for (; s < n; ) {
        ...
        switch (o) {
          ...
          case 35:
            return bl(t, s);
          case 33:
            return le(t, f.BANG, s, s + 1);
          case 36:
            return le(t, f.DOLLAR, s, s + 1);
          case 38:
            return le(t, f.AMP, s, s + 1);
          case 40:
            return le(t, f.PAREN_L, s, s + 1);
          case 41:
            return le(t, f.PAREN_R, s, s + 1);
          case 46:
            if (i.charCodeAt(s + 1) === 46 && i.charCodeAt(s + 2) === 46)
              return le(t, f.SPREAD, s, s + 3);
            break;
          case 58:
            return le(t, f.COLON, s, s + 1);
          case 61:
            return le(t, f.EQUALS, s, s + 1);
          case 64:
            return le(t, f.AT, s, s + 1);
          case 91:
            return le(t, f.BRACKET_L, s, s + 1);
          case 93:
            return le(t, f.BRACKET_R, s, s + 1);
          case 123:
            return le(t, f.BRACE_L, s, s + 1);
          case 124:
            return le(t, f.PIPE, s, s + 1);
          case 125:
            return le(t, f.BRACE_R, s, s + 1);
          case 34:
            return i.charCodeAt(s + 1) === 34 && i.charCodeAt(s + 2) === 34 ? Xl(t, s) : yl(t, s);
        }
        if (wt(o) || o === 45)
          return Zl(t, s, o);
        if (co(o))
          return Vl(t, s);
        throw he2(t.source, s, o === 39 ? `Unexpected single quote character ('), did you mean to use a double quote (")?` : mt(o) || ci(i, s) ? `Unexpected character: ${qe(t, s)}.` : `Invalid character: ${qe(t, s)}.`);
      }
      return le(t, f.EOF, n, n);
    }
    function bl(t, e) {
      const i = t.source.body, n = i.length;
      let s = e + 1;
      ...
      return le(t, f.COMMENT, e, s, i.slice(e + 1, s));
    }
    function Zl(t, e, i) {
      ...
      if (o === 45 && (o = n.charCodeAt(++s)), o === 48) {
        if (o = n.charCodeAt(++s), wt(o))
          throw he2(t.source, s, `Invalid number, unexpected digit after 0: ${qe(t, s)}.`);
      } else
        s = un(t, s, o), o = n.charCodeAt(s);
      if (o === 46 && (r = true, o = n.charCodeAt(++s), s = un(t, s, o), o = n.charCodeAt(s)), o !== 69 && o !== 101 || (r = true, o = n.charCodeAt(++s), o !== 43 && o !== 45 || (o = n.charCodeAt(++s)), s = un(t, s, o), o = n.charCodeAt(s)), o === 46 || co(o))
        throw he2(t.source, s, `Invalid number, expected digit but got: ${qe(t, s)}.`);
      return le(t, r ? f.FLOAT : f.INT, e, s, n.slice(e, s));
    }
    function un(t, e, i) {
      if (!wt(i))
        throw he2(t.source, e, `Invalid number, expected digit but got: ${qe(t, e)}.`);
      const n = t.source.body;
      let s = e + 1;
    ...
    function yl(t, e) {
      ...
      for (; s < n; ) {
        ...
        if (a === 34)
          return r += i.slice(o, s), le(t, f.STRING, e, s + 1, r);
        if (a !== 92) {
          if (a === 10 || a === 13)
            break;
          if (mt(a))
            ...
            if (!ci(i, s))
              throw he2(t.source, s, `Invalid character within String: ${qe(t, s)}.`);
            s += 2;
          }
        } else {
          r += i.slice(o, s);
          const l = i.charCodeAt(s + 1) === 117 ? i.charCodeAt(s + 2) === 123 ? gl(t, s) : Il(t, s) : Sl(t, s);
          r += l.value, s += l.size, o = s;
        }
      }
      throw he2(t.source, s, "Unterminated string.");
    }
    function gl(t, e) {
      ...
      throw he2(t.source, e, `Invalid Unicode escape sequence: "${i.slice(e, e + s)}".`);
    }
    function Il(t, e) {
      ...
      throw he2(t.source, e, `Invalid Unicode escape sequence: "${i.slice(e, e + 6)}".`);
    }
    function po(t, e) {
...
`, size: 2 };
      ...
      throw he2(t.source, e, `Invalid character escape sequence: "${i.slice(e, e + 2)}".`);
    }
    function Xl(t, e) {
      const i = t.source.body, n = i.length;
      ...
      for (; o < n; ) {
        ...
        if (c === 34 && i.charCodeAt(o + 1) === 34 && i.charCodeAt(o + 2) === 34) {
          ...
          const d = le(t, f.BLOCK_STRING, e, o + 3, ul(l).join(`
`));
        ...
        if (c !== 92 || i.charCodeAt(o + 1) !== 34 || i.charCodeAt(o + 2) !== 34 || i.charCodeAt(o + 3) !== 34)
          if (c !== 10 && c !== 13)
            if (mt(c))
              ...
              if (!ci(i, o))
                throw he2(t.source, o, `Invalid character within String: ${qe(t, o)}.`);
              o += 2;
            }
          else
      ...
      throw he2(t.source, o, "Unterminated string.");
    }
    function Vl(t, e) {
      const i = t.source.body, n = i.length;
      let s = e + 1;
      for (; s < n && dl(i.charCodeAt(s)); )
        ++s;
      return le(t, f.NAME, e, s, i.slice(e, s));
    }
    const Gl = 10, mo = 2;
    function hn(t) {
      return di(t, []);
          ...
          return function(i, n) {
            ...
            if (function(o) {
              ...
              return function(o, r) {
                ...
                if (r.length > mo)
                  return "[Array]";
                const a = Math.min(Gl, o.length), l = o.length - a, c = [];
                for (let d = 0; d < a; ++d)
                  c.push(di(o[d], r));
    ...
    const fl = globalThis.process && globalThis.process.env.NODE_ENV === "production" ? function(t, e) {
...
spurious results.`);
    ...
    class bo {
      constructor(e, i = "GraphQL request", n = { line: 1, column: 1 }) {
        typeof e == "string" || ai(false, `Body must be a string. Received: ${hn(e)}.`), this.body = e, this.name = i, this.locationOffset = n, this.locationOffset.line > 0 || ai(false, "line in locationOffset is 1-indexed and must be positive."), this.locationOffset.column > 0 || ai(false, "column in locationOffset is 1-indexed and must be positive.");
      }
      get [Symbol.toStringTag]() {
        return "Source";
      }
    ...
    function Zo(t, e) {
      return new Wl(t, e).parseDocument();
    }
    class Wl {
      constructor(e, i = {}) {
        const n = function(s) {
        ...
        this._lexer = new pl(n), this._options = i, this._tokenCounter = 0;
      }
      parseName() {
      ...
      parseDocument() {
        return this.node(this._lexer.token, { kind: E.DOCUMENT, definitions: this.many(f.SOF, this.parseDefinition, f.EOF) });
      }
      parseDefinition() {
        ...
        if (i.kind === f.NAME) {
          ...
          if (e)
            throw he2(this._lexer.source, this._lexer.token.start, "Unexpected description, descriptions are supported only on type definitions.");
          switch (i.value) {
            case "query":
            case "mutation":
            case "subscription":
      ...
      parseOperationDefinition() {
        ...
        let n;
        return this.peek(f.NAME) && (n = this.parseName()), this.node(e, { kind: E.OPERATION_DEFINITION, operation: i, name: n, variableDefinitions: this.parseVariableDefinitions(), directives: this.parseDirectives(false), selectionSet: this.parseSelectionSet() });
      }
      parseOperationType() {
        const e = this.expectToken(f.NAME);
        switch (e.value) {
      ...
      parseVariableDefinition() {
        return this.node(this._lexer.token, { kind: E.VARIABLE_DEFINITION, variable: this.parseVariable(), type: (this.expectToken(f.COLON), this.parseTypeReference()), defaultValue: this.expectOptionalToken(f.EQUALS) ? this.parseConstValueLiteral() : void 0, directives: this.parseConstDirectives() });
      }
      parseVariable() {
        const e = this._lexer.token;
        return this.expectToken(f.DOLLAR), this.node(e, { kind: E.VARIABLE, name: this.parseName() });
      }
      parseSelectionSet() {
        return this.node(this._lexer.token, { kind: E.SELECTION_SET, selections: this.many(f.BRACE_L, this.parseSelection, f.BRACE_R) });
      }
      parseSelection() {
      ...
      parseField() {
        ...
        let n, s;
        return this.expectOptionalToken(f.COLON) ? (n = i, s = this.parseName()) : s = i, this.node(e, { kind: E.FIELD, alias: n, name: s, arguments: this.parseArguments(false), directives: this.parseDirectives(false), selectionSet: this.peek(f.BRACE_L) ? this.parseSelectionSet() : void 0 });
      }
      parseArguments(e) {
        const i = e ? this.parseConstArgument : this.parseArgument;
        return this.optionalMany(f.PAREN_L, i, f.PAREN_R);
      }
      parseArgument(e = false) {
        const i = this._lexer.token, n = this.parseName();
        return this.expectToken(f.COLON), this.node(i, { kind: E.ARGUMENT, name: n, value: this.parseValueLiteral(e) });
      }
      parseConstArgument() {
      ...
      parseFragment() {
        ...
        return !i && this.peek(f.NAME) ? this.node(e, { kind: E.FRAGMENT_SPREAD, name: this.parseFragmentName(), directives: this.parseDirectives(false) }) : this.node(e, { kind: E.INLINE_FRAGMENT, typeCondition: i ? this.parseNamedType() : void 0, directives: this.parseDirectives(false), selectionSet: this.parseSelectionSet() });
      }
      parseFragmentDefinition() {
        const e = this._lexer.token;
        return this.expectKeyword("fragment"), this._options.allowLegacyFragmentVariables === true ? this.node(e, { kind: E.FRAGMENT_DEFINITION, name: this.parseFragmentName(), variableDefinitions: this.parseVariableDefinitions(), typeCondition: (this.expectKeyword("on"), this.parseNamedType()), directives: this.parseDirectives(false), selectionSet: this.parseSelectionSet() }) : this.node(e, { kind: E.FRAGMENT_DEFINITION, name: this.parseFragmentName(), typeCondition: (this.expectKeyword("on"), this.parseNamedType()), directives: this.parseDirectives(false), selectionSet: this.parseSelectionSet() });
      }
      parseFragmentName() {
        ...
        switch (i.kind) {
          ...
          case f.NAME:
            switch (this.advanceLexer(), i.value) {
              case "true":
                return this.node(i, { kind: E.BOOLEAN, value: true });
              case "false":
                return this.node(i, { kind: E.BOOLEAN, value: false });
              case "null":
          ...
          case f.DOLLAR:
            if (e) {
              if (this.expectToken(f.DOLLAR), this._lexer.token.kind === f.NAME) {
                ...
                throw he2(this._lexer.source, i.start, `Unexpected variable "$${n}" in constant value.`);
              }
              throw this.unexpected(i);
            }
      ...
      parseStringLiteral() {
        const e = this._lexer.token;
        return this.advanceLexer(), this.node(e, { kind: E.STRING, value: e.value, block: e.kind === f.BLOCK_STRING });
      }
      parseList(e) {
        return this.node(this._lexer.token, { kind: E.LIST, values: this.any(f.BRACKET_L, () => this.parseValueLiteral(e), f.BRACKET_R) });
      }
      parseObject(e) {
        return this.node(this._lexer.token, { kind: E.OBJECT, fields: this.any(f.BRACE_L, () => this.parseObjectField(e), f.BRACE_R) });
      }
      parseObjectField(e) {
        const i = this._lexer.token, n = this.parseName();
        return this.expectToken(f.COLON), this.node(i, { kind: E.OBJECT_FIELD, name: n, value: this.parseValueLiteral(e) });
      }
      parseDirectives(e) {
        const i = [];
        for (; this.peek(f.AT); )
      ...
      parseDirective(e) {
        const i = this._lexer.token;
        return this.expectToken(f.AT), this.node(i, { kind: E.DIRECTIVE, name: this.parseName(), arguments: this.parseArguments(e) });
      }
      parseTypeReference() {
        const e = this._lexer.token;
        let i;
        if (this.expectOptionalToken(f.BRACKET_L)) {
          ...
          this.expectToken(f.BRACKET_R), i = this.node(e, { kind: E.LIST_TYPE, type: n });
        } else
          i = this.parseNamedType();
        return this.expectOptionalToken(f.BANG) ? this.node(e, { kind: E.NON_NULL_TYPE, type: i }) : i;
      }
      parseNamedType() {
      ...
      parseSchemaDefinition() {
        ...
        const n = this.parseConstDirectives(), s = this.many(f.BRACE_L, this.parseOperationTypeDefinition, f.BRACE_R);
      ...
      parseInputValueDef() {
        ...
        let o;
        this.expectOptionalToken(f.EQUALS) && (o = this.parseConstValueLiteral());
      ...
      parseEnumValueName() {
        if (this._lexer.token.value === "true" || this._lexer.token.value === "false" || this._lexer.token.value === "null")
          throw he2(this._lexer.source, this._lexer.token.start, `${ui(this._lexer.token)} is reserved and cannot be used for an enum value.`);
        return this.parseName();
      }
      ...
      parseSchemaExtension() {
        ...
        const i = this.parseConstDirectives(), n = this.optionalMany(f.BRACE_L, this.parseOperationTypeDefinition, f.BRACE_R);
      ...
      node(e, i) {
        return this._options.noLocation !== true && (i.loc = new al(e, this._lexer.lastToken, this._lexer.source)), i;
      }
      peek(e) {
      ...
      expectToken(e) {
        ...
        throw he2(this._lexer.source, i.start, `Expected ${yo(e)}, found ${ui(i)}.`);
      }
      expectOptionalToken(e) {
        return this._lexer.token.kind === e && (this.advanceLexer(), true);
      }
      expectKeyword(e) {
        const i = this._lexer.token;
        if (i.kind !== f.NAME || i.value !== e)
          throw he2(this._lexer.source, i.start, `Expected "${e}", found ${ui(i)}.`);
        this.advanceLexer();
      }
      expectOptionalKeyword(e) {
        const i = this._lexer.token;
        return i.kind === f.NAME && i.value === e && (this.advanceLexer(), true);
      }
      unexpected(e) {
        const i = e != null ? e : this._lexer.token;
        return he2(this._lexer.source, i.start, `Unexpected ${ui(i)}.`);
      }
      any(e, i, n) {
        this.expectToken(e);
        const s = [];
      ...
      advanceLexer() {
        ...
        if (e !== void 0 && i.kind !== f.EOF && (++this._tokenCounter, this._tokenCounter > e))
          throw he2(this._lexer.source, i.start, `Document contains more that ${e} tokens. Parsing aborted.`);
      }
    }
    function ui(t) {
      const e = t.value;
    ...
    const Rl = /[\x00-\x1f\x22\x5c\x7f-\x9f]/g;
    function vl(t) {
      return Cl[t.charCodeAt(0)];
    }
    const Cl = ["\\u0000", "\\u0001", "\\u0002", "\\u0003", "\\u0004", "\\u0005", "\\u0006", "\\u0007", "\\b", "\\t", "\\n", "\\u000B", "\\f", "\\r", "\\u000E", "\\u000F", "\\u0010", "\\u0011", "\\u0012", "\\u0013", "\\u0014", "\\u0015", "\\u0016", "\\u0017", "\\u0018", "\\u0019", "\\u001A", "\\u001B", "\\u001C", "\\u001D", "\\u001E", "\\u001F", "", "", '\\"', "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "\\\\", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "\\u007F", "\\u0080", "\\u0081", "\\u0082", "\\u0083", "\\u0084", "\\u0085", "\\u0086", "\\u0087", "\\u0088", "\\u0089", "\\u008A", "\\u008B", "\\u008C", "\\u008D", "\\u008E", "\\u008F", "\\u0090", "\\u0091", "\\u0092", "\\u0093", "\\u0094", "\\u0095", "\\u0096", "\\u0097", "\\u0098", "\\u0099", "\\u009A", "\\u009B", "\\u009C", "\\u009D", "\\u009E", "\\u009F"], kl = Object.freeze({});
    function Tl(t, e) {
      const i = t[e];
    ...
    function go(t) {
      return function(e, i, n = ro) {
        ...
        do {
          ...
          if (!Array.isArray(p)) {
            var y, G;
            lo(p) || ai(false, `Invalid AST Node: ${hn(p)}.`);
            const R = g ? (y = s.get(p.kind)) === null || y === void 0 ? void 0 : y.leave : (G = s.get(p.kind)) === null || G === void 0 ? void 0 : G.enter;
            if (I = R == null ? void 0 : R.call(i, p, r, a, m, X), I === kl)
              break;
            if (I === false) {
              if (!g) {
                m.pop();
          ...
          var Z;
          I === void 0 && b && h.push([r, p]), g ? m.pop() : (o = { inArray: l, index: d, keys: c, edits: h, prev: o }, l = Array.isArray(p), c = l ? p : (Z = n[p.kind]) !== null && Z !== void 0 ? Z : [], d = -1, h = [], a && X.push(a), a = p);
        } while (o !== void 0);
        return h.length !== 0 ? h[h.length - 1][1] : e;
      }(t, wl);
    }
    const wl = { Name: { leave: (t) => t.value }, Variable: { leave: (t) => "$" + t.name }, Document: { leave: (t) => Y(t.definitions, `
...
`)), `
      ...
      const s = i.replace(/"""/g, '\\"""'), o = s.split(/\r\n|[\n\r]/g), r = o.length === 1, a = o.length > 1 && o.slice(1).every((y) => y.length === 0 || dn(y.charCodeAt(0))), l = s.endsWith('\\"""'), c = i.endsWith('"') && !l, d = i.endsWith("\\"), h = c || d, p = !(n != null && n.minimize) && (!r || i.length > 70 || h || a || l);
      let m = "";
      const X = r && dn(i.charCodeAt(0));
      return (p && !X || a) && (m += `
`), m += s, (p || h) && (m += `
`), '"""' + m + '"""';
    }(t) : `"${t.replace(Rl, vl)}"` }, BooleanValue: { leave: ({ value: t }) => t ? "true" : "false" }, NullValue: { leave: () => "null" }, EnumValue: { leave: ({ value: t }) => t }, ListValue: { leave: ({ values: t }) => "[" + Y(t, ", ") + "]" }, ObjectValue: { leave: ({ fields: t }) => "{" + Y(t, ", ") + "}" }, ObjectField: { leave: ({ name: t, value: e }) => t + ": " + e }, Directive: { leave: ({ name: t, arguments: e }) => "@" + t + Q("(", Y(e, ", "), ")") }, NamedType: { leave: ({ name: t }) => t }, ListType: { leave: ({ type: t }) => "[" + t + "]" }, NonNullType: { leave: ({ type: t }) => t + "!" }, SchemaDefinition: { leave: ({ description: t, directives: e, operationTypes: i }) => Q("", t, `
...
`))) !== null && e !== void 0 && e;
    ...
    (function(t, e) {
      ...
      i = s, function(r) {
        ...
        function G(u) {
          ...
          return l && (V[Symbol.iterator] = function() {
            return V;
          }), V;
        }
        function Z(u) {
          this.map = {}, u instanceof Z ? u.forEach(function(V, v) {
            this.append(v, V);
        ...
        function I(u) {
          var V = new FileReader(), v = b(V);
          return V.readAsArrayBuffer(u), v;
        }
        function R(u) {
          if (u.slice)
            return u.slice(0);
        ...
        function L() {
          return this.bodyUsed = false, this._initBody = function(u) {
            ...
            if (W)
              return W;
            if (this._bodyBlob)
              return u = this._bodyBlob, V = new FileReader(), v = b(V), V.readAsText(u), v;
            if (this._bodyArrayBuffer)
        ...
        Z.prototype.append = function(u, V) {
          u = X(u), V = y(V);
          var v = this.map[u];
          this.map[u] = v ? v + ", " + V : V;
        }, Z.prototype.delete = function(u) {
          delete this.map[X(u)];
        }, Z.prototype.get = function(u) {
          return u = X(u), this.has(u) ? this.map[u] : null;
        }, Z.prototype.has = function(u) {
          return this.map.hasOwnProperty(X(u));
        }, Z.prototype.set = function(u, V) {
          this.map[X(u)] = y(V);
        }, Z.prototype.forEach = function(u, V) {
          for (var v in this.map)
            this.map.hasOwnProperty(v) && u.call(V, this.map[v], v, this);
        }, Z.prototype.keys = function() {
          var u = [];
          return this.forEach(function(V, v) {
            u.push(v);
          }), G(u);
        ...
        }, l && (Z.prototype[Symbol.iterator] = Z.prototype.entries);
        ...
        function H(u, V) {
          ...
          if (u instanceof H) {
            ...
            this.url = u.url, this.credentials = u.credentials, V.headers || (this.headers = new Z(u.headers)), this.method = u.method, this.mode = u.mode, this.signal = u.signal, M || u._bodyInit == null || (M = u._bodyInit, u.bodyUsed = true);
          } else
            this.url = String(u);
          if (this.credentials = V.credentials || this.credentials || "same-origin", !V.headers && this.headers || (this.headers = new Z(V.headers)), this.method = (v = V.method || this.method || "GET", W = v.toUpperCase(), F.indexOf(W) > -1 ? W : v), this.mode = V.mode || this.mode || null, this.signal = V.signal || this.signal, this.referrer = null, (this.method === "GET" || this.method === "HEAD") && M)
        ...
        function x(u) {
          ...
          return u.trim().split("&").forEach(function(v) {
            if (v) {
              var W = v.split("="), M = W.shift().replace(/\+/g, " "), S = W.join("=").replace(/\+/g, " ");
              V.append(decodeURIComponent(M), decodeURIComponent(S));
            }
          }), V;
        }
        function N(u, V) {
          V || (V = {}), this.type = "default", this.status = V.status === void 0 ? 200 : V.status, this.ok = this.status >= 200 && this.status < 300, this.statusText = "statusText" in V ? V.statusText : "OK", this.headers = new Z(V.headers), this.url = V.url || "", this._initBody(u);
        }
        H.prototype.clone = function() {
          return new H(this, { body: this._bodyInit });
        }, L.call(H.prototype), L.call(N.prototype), N.prototype.clone = function() {
          return new N(this._bodyInit, { status: this.status, statusText: this.statusText, headers: new Z(this.headers), url: this.url });
        }, N.error = function() {
          var u = new N(null, { status: 0, statusText: "" });
          return u.type = "error", u;
        };
        var K = [301, 302, 303, 307, 308];
        N.redirect = function(u, V) {
          if (K.indexOf(V) === -1)
            throw new RangeError("Invalid status code");
          return new N(null, { status: V, headers: { location: u } });
        }, r.DOMException = i.DOMException;
        try {
          new r.DOMException();
        } catch (u) {
          r.DOMException = function(V, v) {
            this.message = V, this.name = v;
            var W = Error(V);
            this.stack = W.stack;
        ...
        function k(u, V) {
          return new Promise(function(v, W) {
            ...
            if (M.signal && M.signal.aborted)
              return W(new r.DOMException("Aborted", "AbortError"));
            var S = new XMLHttpRequest();
            function T() {
              S.abort();
            }
            S.onload = function() {
              var $, A, B = { status: S.status, statusText: S.statusText, headers: ($ = S.getAllResponseHeaders() || "", A = new Z(), $.replace(/\r?\n[\t ]+/g, " ").split(/\r?\n/).forEach(function(Ie) {
              ...
              W(new r.DOMException("Aborted", "AbortError"));
            }, S.open(M.method, M.url, true), M.credentials === "include" ? S.withCredentials = true : M.credentials === "omit" && (S.withCredentials = false), "responseType" in S && c && (S.responseType = "blob"), M.headers.forEach(function($, A) {
        ...
        k.polyfill = true, i.fetch || (i.fetch = k, i.Headers = Z, i.Request = H, i.Response = N), r.Headers = Z, r.Request = H, r.Response = N, r.fetch = k, Object.defineProperty(r, "__esModule", { value: true });
      }({}), s.fetch.ponyfill = true, delete s.fetch.polyfill;
      var o = s;
      (e = o.fetch).default = o.fetch, e.fetch = o.fetch, e.Headers = o.Headers, e.Request = o.Request, e.Response = o.Response, t.exports = e;
    })(mn, mn.exports);
    var pi = mn.exports;
    const mi = ji(pi), Nl = or({ __proto__: null, default: mi }, [pi]), Zt = (t) => {
      let e = {};
      return t && (typeof Headers != "undefined" && t instanceof Headers || Nl && pi.Headers && t instanceof pi.Headers ? e = ((i) => {
        const n = {};
    ...
    }, Xo = (t) => t.replace(/([\s,]|#[^\n\r]+)+/g, " ").trim(), Ll = (t) => (e) => ne(this, null, function* () {
      var i;
      const { url: n, query: s, variables: o, operationName: r, fetch: a, fetchOptions: l, middleware: c } = e, d = U({}, e.headers);
      let h, p = "";
      t === "POST" ? (h = Jl(s, o, r, l.jsonSerializer), typeof h == "string" && (d["Content-Type"] = "application/json")) : p = ((G) => {
        if (!Array.isArray(G.query)) {
          const b = G, I = [`query=${encodeURIComponent(Xo(b.query))}`];
          return G.variables && I.push(`variables=${encodeURIComponent(b.jsonSerializer.stringify(b.variables))}`), b.operationName && I.push(`operationName=${encodeURIComponent(b.operationName)}`), I.join("&");
        }
        if (G.variables !== void 0 && !Array.isArray(G.variables))
          throw new Error("Cannot create query with given variable type, array expected");
        const Z = G, g = G.query.reduce((b, I, R) => (b.push({ query: Xo(I), variables: Z.variables ? Z.jsonSerializer.stringify(Z.variables[R]) : void 0 }), b), []);
        return `query=${encodeURIComponent(Z.jsonSerializer.stringify(g))}`;
      })({ query: s, variables: o, operationName: r, jsonSerializer: (i = l.jsonSerializer) != null ? i : on });
      const m = U({ method: t, headers: d, body: h }, l);
      let X = n, y = m;
      if (c) {
        const G = yield Promise.resolve(c(Ve(U({}, m), { url: n, operationName: r, variables: o }))), { url: Z } = G;
        X = Z, y = Ue(G, ["url"]);
      }
      return p && (X = `${X}?${p}`), yield a(X, y);
    });
    class xl {
      constructor(e, i = {}) {
        this.url = e, this.requestConfig = i, this.rawRequest = (...n) => ne(this, null, function* () {
          const [s, o, r] = n, a = ((Z, g, b) => Z.query ? Z : { query: Z, variables: g, requestHeaders: b, signal: void 0 })(s, o, r), l = this.requestConfig, { headers: c, fetch: d = mi, method: h = "POST", requestMiddleware: p, responseMiddleware: m } = l, X = Ue(l, ["headers", "fetch", "method", "requestMiddleware", "responseMiddleware"]), { url: y } = this;
          a.signal !== void 0 && (X.signal = a.signal);
          const { operationName: G } = pn(a.query);
          return bn({ url: y, query: a.query, variables: a.variables, headers: U(U({}, Zt(Zn(c))), Zt(a.requestHeaders)), operationName: G, fetch: d, method: h, fetchOptions: X, middleware: p }).then((Z) => (m && m(Z), Z)).catch((Z) => {
            throw m && m(Z), Z;
          });
        });
      }
      request(e, ...i) {
        return ne(this, null, function* () {
          const [n, s] = i, o = ((G, Z, g) => G.document ? G : { document: G, variables: Z, requestHeaders: g, signal: void 0 })(e, n, s), r = this.requestConfig, { headers: a, fetch: l = mi, method: c = "POST", requestMiddleware: d, responseMiddleware: h } = r, p = Ue(r, ["headers", "fetch", "method", "requestMiddleware", "responseMiddleware"]), { url: m } = this;
          o.signal !== void 0 && (p.signal = o.signal);
          const { query: X, operationName: y } = pn(o.document);
          return bn({ url: m, query: X, variables: o.variables, headers: U(U({}, Zt(Zn(a))), Zt(o.requestHeaders)), operationName: y, fetch: l, method: c, fetchOptions: p, middleware: d }).then((G) => (h && h(G), G.data)).catch((G) => {
            throw h && h(G), G;
          });
        });
      }
    ...
    const bn = (t) => ne(this, null, function* () {
      var e, i;
      const { query: n, variables: s, fetchOptions: o } = t, r = Ll(((e = t.method) != null ? e : "post").toUpperCase()), a = Array.isArray(t.query), l = yield r(t), c = yield Yl(l, (i = o.jsonSerializer) != null ? i : on), d = Array.isArray(c) ? !c.some(({ data: p }) => !p) : !!c.data, h = Array.isArray(c) || !c.errors || Array.isArray(c.errors) && !c.errors.length || o.errorPolicy === "all" || o.errorPolicy === "ignore";
      if (l.ok && h && d) {
    ...
    }, Zi = /* @__PURE__ */ new Map(), yn = /* @__PURE__ */ new Map(), Vo = true, yi = false;
    function Go(t) {
...
this in the docs: http://dev.apollodata.com/core/fragments.html#unique-names`) : r || yn.set(s, r = /* @__PURE__ */ new Set()), r.add(o), e.has(o) || (e.add(o), i.push(n));
    ...
    (Lt = Ge || (Ge = {})).gql = Fl, Lt.resetCaches = Hl, Lt.disableFragmentWarnings = El, Lt.enableExperimentalFragmentVariables = Ml, Lt.disableExperimentalFragmentVariables = zl, Ge.default = Ge;
    const fo = Ge`
...
`, _l = (t, e, i, n) => t(), ql = (t) => {
      ...
      const i = (o) => {
        if (o.key === "ajs_user_id" || o.key === "ajs_anonymous_id" || o.key === "ajs_user_traits") {
          const { userId: r, userTraits: a } = Wo();
          if (r) {
            let l = {};
            a && (l = JSON.parse(a));
    ...
    }, Wo = () => ({ userId: Xe("ajs_user_id"), userTraits: Xe("ajs_user_traits"), anonymousId: Xe("ajs_anonymous_id") }), gn = (t) => {
      if (!t)
        return false;
      let e = "";
      try {
      ...
      const i = $l(e), n = Xe(ce.SEGMENT_LAST_SENT_HASH_KEY);
      return (n === void 0 || i !== n) && (we(ce.SEGMENT_LAST_SENT_HASH_KEY, i), true);
    }, $l = (t) => {
    ...
    const ea = (t) => {
    ...
    }, Co = (t, e) => `${e}${t.trim().split(" ").join(e)}`, ta = (t, e) => {
      const i = function(a) {
        typeof a != "string" && (a = "");
      ...
      for (let a = 0; a < i.length; a++) {
        let l = i[a].split("+");
        n = [], l.length > 1 && (n = sa(To, l)), l = l[l.length - 1], l = l === "*" ? "*" : na(l), l in Je || (Je[l] = []), Je[l].push({ mods: n, shortcut: i[a], key: i[a], method: e, keyup: false, keydown: true, scope: "all", splitKey: "+" });
      }
      var s, o, r;
      s = document, o = "keydown", r = (a) => {
        (function(l) {
          ...
          if (d !== 93 && d !== 224 || (d = 91), ye.indexOf(d) === -1 && d !== 229 && ye.push(d), ["ctrlKey", "altKey", "shiftKey", "metaKey"].forEach((h) => {
            ...
            if (l.getModifierState && (!l.altKey || l.ctrlKey) && l.getModifierState("AltGraph") && (ye.indexOf(17) === -1 && ye.push(17), ye.indexOf(18) === -1 && ye.push(18), ge[17] = true, ge[18] = true), d in Je) {
      ...
      }, s.addEventListener ? s.addEventListener(o, r, false) : s.attachEvent && s.attachEvent(`on${o}`, () => {
        r(window.event);
      });
    };
    let ye = [];
    const Je = {}, In = typeof navigator != "undefined" && navigator.userAgent.toLowerCase().indexOf("firefox") > 0, ia = { backspace: 8, tab: 9, clear: 12, enter: 13, return: 13, esc: 27, escape: 27, space: 32, left: 37, up: 38, right: 39, down: 40, del: 46, delete: 46, ins: 45, insert: 45, home: 36, end: 35, pageup: 33, pagedown: 34, capslock: 20, num_0: 96, num_1: 97, num_2: 98, num_3: 99, num_4: 100, num_5: 101, num_6: 102, num_7: 103, num_8: 104, num_9: 105, num_multiply: 106, num_add: 107, num_enter: 108, num_subtract: 109, num_decimal: 110, num_divide: 111, "⇪": 20, ",": 188, ".": 190, "/": 191, "`": 192, "-": In ? 173 : 189, "=": In ? 61 : 187, ";": In ? 59 : 186, "'": 222, "[": 219, "]": 221, "\\": 220 }, ko = { 16: "shiftKey", 18: "altKey", 17: "ctrlKey", 91: "metaKey", shiftKey: 16, ctrlKey: 17, altKey: 18, metaKey: 91 }, ge = { 16: false, 18: false, 17: false, 91: false }, To = { "⇧": 16, shift: 16, "⌥": 18, alt: 18, option: 18, "⌃": 17, ctrl: 17, control: 17, "⌘": 91, cmd: 91, command: 91 }, na = (t) => ia[t.toLowerCase()] || To[t.toLowerCase()] || t.toUpperCase().charCodeAt(0);
    function sa(t, e) {
    ...
    function oa(t, e, i) {
      ...
      if (e.scope === i || e.scope === "all") {
        n = e.mods.length > 0;
        for (const s in ge)
          Object.prototype.hasOwnProperty.call(ge, s) && (!ge[s] && e.mods.indexOf(+s) > -1 || ge[s] && e.mods.indexOf(+s) === -1) && (n = false);
        (e.mods.length !== 0 || ge[16] || ge[18] || ge[17] || ge[91]) && !n && e.shortcut !== "*" || e.method(t, e) === false && (t.preventDefault ? t.preventDefault() : t.returnValue = false, t.stopPropagation && t.stopPropagation(), t.cancelBubble && (t.cancelBubble = true));
      }
    }
    var Oe, xt, wo, gi, Sn, No = -1, $e = function(t) {
      ...
      try {
        if (PerformanceObserver.supportedEntryTypes.includes(t)) {
          ...
          return n.observe(Object.assign({ type: t, buffered: true }, i || {})), n;
        }
      } catch (s) {
      }
    }, Ce = function(t, e, i, n) {
      ...
      document.visibilityState === "hidden" && gt > -1 && (gt = t.type === "visibilitychange" ? t.timeStamp : 0, ra());
    }, xo = function() {
      addEventListener("visibilitychange", Xi, true), addEventListener("prerenderingchange", Xi, true);
    }, ra = function() {
      removeEventListener("visibilitychange", Xi, true), removeEventListener("prerenderingchange", Xi, true);
    }, fn = function() {
      ...
      e = e || {}, Jt(function() {
        var i, n = fn(), s = ve("FCP"), o = yt("paint", function(r) {
          r.forEach(function(a) {
            a.name === "first-contentful-paint" && (o.disconnect(), a.startTime < n.firstHiddenTime && (s.value = Math.max(a.startTime - Ii(), 0), s.entries.push(a), i(true)));
          });
        });
        o && (i = Ce(t, s, Jo, e.reportAllChanges), $e(function(r) {
          s = ve("FCP"), i = Ce(t, s, Jo, e.reportAllChanges), Vn(function() {
            s.value = performance.now() - r.timeStamp, i(true);
          });
        }));
      });
    }, Ko = [0.1, 0.25], Yt = { passive: true, capture: true }, la = /* @__PURE__ */ new Date(), Uo = function(t, e) {
    ...
    }, Eo = [100, 300], Mo = 0, Wn = 1 / 0, Vi = 0, ca = function(t) {
      t.forEach(function(e) {
        e.interactionId && (Wn = Math.min(Wn, e.interactionId), Vi = Math.max(Vi, e.interactionId), Mo = Vi ? (Vi - Wn) / 7 + 1 : 0);
      });
    }, zo = function() {
      ...
      e = e || {}, Jt(function() {
        var i;
        "interactionCount" in performance || Sn || (Sn = yt("event", ca, { type: "event", buffered: true, durationThreshold: 0 }));
        ...
        n = Ce(t, s, Oo, e.reportAllChanges), r && ("interactionId" in PerformanceEventTiming.prototype && r.observe({ type: "first-input", buffered: true }), Si(function() {
          o(r.takeRecords()), s.value < 0 && Bo() > 0 && (s.value = 0, s.entries = []), n(true);
        }), $e(function() {
          Ye = [], Po = zo(), s = ve("INP"), n = Ce(t, s, Oo, e.reportAllChanges);
        }));
      });
    }, Qo = [2500, 4e3], vn = {}, jo = [800, 1800], ua = function t(e) {
      ...
      ua(function() {
        ...
        if (s) {
          ...
          if (o <= 0 || o > performance.now())
            return;
          i.value = Math.max(o - Ii(), 0), i.entries = [s], n(true), $e(function() {
            i = ve("TTFB", 0), (n = Ce(t, i, jo, e.reportAllChanges))(true);
          });
        }
      });
    };
    const pa = (t) => {
      ...
      return e = t, i = i || {}, Yo(Gn(function() {
        ...
        s = s || {}, Jt(function() {
          var o, r = fn(), a = ve("FID"), l = function(h) {
            h.startTime < r.firstHiddenTime && (a.value = h.processingStart - h.startTime, a.entries.push(h), o(true));
          }, c = function(h) {
            h.forEach(l);
          }, d = yt("first-input", c);
        ...
        s = s || {}, Jt(function() {
          var o, r = fn(), a = ve("LCP"), l = function(h) {
            var p = h[h.length - 1];
          ...
          if (c) {
            ...
            var d = Gn(function() {
              vn[a.id] || (l(c.takeRecords()), c.disconnect(), vn[a.id] = true, o(true));
            });
            ["keydown", "click"].forEach(function(h) {
              ...
              a = ve("LCP"), o = Ce(n, a, Qo, s.reportAllChanges), Vn(function() {
                a.value = performance.now() - h.timeStamp, vn[a.id] = true, o(true);
              });
            });
          }
        });
    ...
    }, Cn = (t) => t / Math.pow(1e3, 2), ma = (t) => 1024 * t, Ao = typeof window != "undefined" && "performance" in window && "memory" in performance ? performance : { memory: {} }, Kt = "highlightLogs", ba = (t) => {
      if (!t)
        return;
      let e = Xe(Kt) || "";
...
`, " ")));
    ...
    const ya = [$o.BillingQuotaExceeded.toString()], ga = (t) => {
      const e = (i, n, s, o, r = 0) => ne(this, null, function* () {
        try {
          ...
          if (a instanceof bt && !((l) => {
            var c;
            return ((c = l.response.errors) == null ? void 0 : c.find((d) => ya.includes(d.message))) === void 0;
          })(a))
            throw a;
          if (r < 10)
    ...
    const Sa = () => ne(this, null, function* () {
      const t = [];
      for (let e = 0; e < 30; e++)
    ...
    class kn {
      constructor(e, i) {
        var n, s, o, r, a, l;
        w(this, "options"), w(this, "isRunningOnHighlight"), w(this, "organizationID"), w(this, "graphqlSDK"), w(this, "events"), w(this, "sessionData"), w(this, "ready"), w(this, "manualStopped"), w(this, "state"), w(this, "logger"), w(this, "enableSegmentIntegration"), w(this, "privacySetting"), w(this, "enableCanvasRecording"), w(this, "enablePerformanceRecording"), w(this, "samplingStrategy"), w(this, "inlineImages"), w(this, "inlineStylesheet"), w(this, "debugOptions"), w(this, "listeners"), w(this, "firstloadVersion"), w(this, "environment"), w(this, "sessionShortcut"), w(this, "appVersion"), w(this, "serviceName"), w(this, "_worker"), w(this, "_optionsInternal"), w(this, "_backendUrl"), w(this, "_recordingStartTime"), w(this, "_isOnLocalHost"), w(this, "_onToggleFeedbackFormVisibility"), w(this, "_firstLoadListeners"), w(this, "_isCrossOriginIframe"), w(this, "_eventBytesSinceSnapshot"), w(this, "_lastSnapshotTime"), w(this, "_lastVisibilityChangeTime"), w(this, "pushPayloadTimerId"), w(this, "hasSessionUnloaded"), w(this, "hasPushedData"), w(this, "reloaded"), w(this, "_hasPreviouslyInitialized"), w(this, "_payloadId"), w(this, "_recordStop"), e.sessionSecureID || (e.sessionSecureID = Gi()), this.options = e, typeof ((n = this.options) == null ? void 0 : n.debug) == "boolean" ? this.debugOptions = this.options.debug ? { clientInteractions: true } : {} : this.debugOptions = (o = (s = this.options) == null ? void 0 : s.debug) != null ? o : {}, this.logger = new Ia(this.debugOptions.clientInteractions), e.storageMode && (this.logger.log(`initializing in ${e.storageMode} session mode`), l = e.storageMode, qi = l), this._worker = new Za(), this._worker.onmessage = (d) => {
          var h, p;
        ...
        let c = Qs();
        if (this.reloaded = false, !((r = this.sessionData) != null && r.sessionSecureID) && (c == null ? void 0 : c.sessionSecureID))
          this.sessionData = c, this.options.sessionSecureID = c.sessionSecureID, this.reloaded = true, this.logger.log(`Tab reloaded, continuing previous session: ${this.sessionData.sessionSecureID}`);
        else {
        ...
        this._hasPreviouslyInitialized = false, this._firstLoadListeners = i || new He(this.options);
        try {
          window.parent.document && (this._isCrossOriginIframe = false);
        } catch (d) {
      ...
      _initMembers(e) {
        ...
        this.sessionShortcut = false, this._recordingStartTime = 0, this._isOnLocalHost = window.location.hostname === "localhost" || window.location.hostname === "127.0.0.1" || window.location.hostname === "", this.ready = false, this.state = "NotRecording", this.manualStopped = false, this.enableSegmentIntegration = !!e.enableSegmentIntegration, this.privacySetting = (i = e.privacySetting) != null ? i : "default", this.enableCanvasRecording = (n = e.enableCanvasRecording) != null && n, this.enablePerformanceRecording = (s = e.enablePerformanceRecording) == null || s, this.inlineImages = (o = e.inlineImages) != null ? o : this._isOnLocalHost, this.inlineStylesheet = (r = e.inlineStylesheet) == null || r, this.samplingStrategy = U({ canvasFactor: 0.5, canvasMaxSnapshotDimension: 360, canvasClearWebGLBuffer: true, dataUrlOptions: Kr() }, (a = e.samplingStrategy) != null ? a : { canvas: 2 }), this._backendUrl = (l = e == null ? void 0 : e.backendUrl) != null ? l : "https://pub.highlight.io", this._backendUrl[0] === "/" && (this._backendUrl = new URL(this._backendUrl, document.baseURI).href);
        const X = new xl(`${this._backendUrl}`, { headers: {} });
        this.graphqlSDK = /* @__PURE__ */ function(Z, g = _l) {
          return { PushPayload: (b, I) => g((R) => Z.request(fo, b, U(U({}, I), R)), "PushPayload", "mutation", b), PushPayloadCompressed: (b, I) => g((R) => Z.request(Ol, b, U(U({}, I), R)), "PushPayloadCompressed", "mutation", b), identifySession: (b, I) => g((R) => Z.request(Pl, b, U(U({}, I), R)), "identifySession", "mutation", b), addSessionProperties: (b, I) => g((R) => Z.request(Bl, b, U(U({}, I), R)), "addSessionProperties", "mutation", b), pushMetrics: (b, I) => g((R) => Z.request(Dl, b, U(U({}, I), R)), "pushMetrics", "mutation", b), addSessionFeedback: (b, I) => g((R) => Z.request(Ql, b, U(U({}, I), R)), "addSessionFeedback", "mutation", b), initializeSession: (b, I) => g((R) => Z.request(jl, b, U(U({}, I), R)), "initializeSession", "mutation", b), Ignore: (b, I) => g((R) => Z.request(Al, b, U(U({}, I), R)), "Ignore", "query", b) };
        }(X, ga(((c = this.sessionData) == null ? void 0 : c.sessionSecureID) || ((d = this.options) == null ? void 0 : d.sessionSecureID))), this.environment = (h = e.environment) != null ? h : "production", this.appVersion = e.appVersion, this.serviceName = (p = e.serviceName) != null ? p : "", typeof e.organizationID == "string" ? this.organizationID = e.organizationID : this.organizationID = e.organizationID.toString(), this.isRunningOnHighlight = this.organizationID === "1" || this.organizationID === "1jdkoe52", this.firstloadVersion = e.firstloadVersion || "unknown", this.sessionShortcut = e.sessionShortcut || false, this._onToggleFeedbackFormVisibility = () => {
        };
        const y = e, G = Ue(y, ["firstloadVersion"]);
        this._optionsInternal = G, this.listeners = [], this.events = [], this.hasSessionUnloaded = false, this.hasPushedData = false, window.Intercom && window.Intercom("onShow", () => {
        ...
        return ne(this, null, function* () {
          ...
          if (this.logger.log("Initializing...", e, this.sessionData, this.options), (navigator == null ? void 0 : navigator.webdriver) && !window.Cypress || ((i = navigator == null ? void 0 : navigator.userAgent) == null ? void 0 : i.includes("Googlebot")) || ((n = navigator == null ? void 0 : navigator.userAgent) == null ? void 0 : n.includes("AdsBot")))
            ...
            try {
              ...
              d || (d = Gi(), we("highlightClientID", d)), tn(null), c = !this.options.disableSessionRecording && this.options.disableNetworkRecording === void 0 && typeof this.options.networkRecording != "boolean" && (((o = this.options.networkRecording) == null ? void 0 : o.recordHeadersAndBody) || false);
              let h = [];
              if (typeof this.options.networkRecording == "object" && ((r = this.options.networkRecording.destinationDomains) != null && r.length) && (h = this.options.networkRecording.destinationDomains), this._isCrossOriginIframe)
                ...
                const Z = yield this.graphqlSDK.initializeSession({ organization_verbose_id: this.organizationID, enable_strict_privacy: this.privacySetting === "strict", privacy_setting: this.privacySetting, enable_recording_network_contents: c, clientVersion: this.firstloadVersion, firstloadVersion: this.firstloadVersion, clientConfig: JSON.stringify(this._optionsInternal), environment: this.environment, id: d, appVersion: this.appVersion, serviceName: this.serviceName, session_secure_id: this.sessionData.sessionSecureID, client_id: d, network_recording_domains: h, disable_session_recording: this.options.disableSessionRecording });
                if (Z.initializeSession.secure_id !== this.sessionData.sessionSecureID && this.logger.log(`Unexpected secure id returned by initializeSession: ${Z.initializeSession.secure_id}, expected ${this.sessionData.sessionSecureID}`), this.sessionData.sessionSecureID = Z.initializeSession.secure_id, this.sessionData.projectID = parseInt(((a = Z == null ? void 0 : Z.initializeSession) == null ? void 0 : a.project_id) || "0"), !this.sessionData.projectID || !this.sessionData.sessionSecureID)
...
SessionSecureID: ${this.sessionData.sessionSecureID}`), this.options.sessionSecureID = this.sessionData.sessionSecureID, this._worker.postMessage({ message: { type: Ee.Initialize, sessionSecureID: this.sessionData.sessionSecureID, backend: this._backendUrl, debug: !!this.debugOptions.clientInteractions, recordingStartTime: this._recordingStartTime } }), js(this.sessionData.sessionSecureID), this.sessionData.userIdentifier && this.identify(this.sessionData.userIdentifier, this.sessionData.userObject), this._firstLoadListeners.isListening() ? this._firstLoadListeners.hasNetworkRecording || He.setupNetworkListener(this._firstLoadListeners, this.options) : this._firstLoadListeners.startListening(), this.pushPayloadTimerId && (clearTimeout(this.pushPayloadTimerId), this.pushPayloadTimerId = void 0), this._isCrossOriginIframe || (this.pushPayloadTimerId = setTimeout(() => {
                ...
                return this.logger.log("Highlight is NOT RECORDING a session replay per H.init setting."), this.ready = true, this.state = "Recording", void (this.manualStopped = false);
              const { getDeviceDetails: p } = (() => {
                if (!("performance" in window) || !("memory" in performance))
                  return { getDeviceDetails: void 0, getCurrentDeviceDetails: void 0 };
                const Z = window.performance;
                return { getDeviceDetails: () => ({ deviceMemory: ma(navigator.deviceMemory || 0) }), getCurrentDeviceDetails: () => ({ jsHeapSizeLimit: Cn(Z.memory.jsHeapSizeLimit), totalJSHeapSize: Cn(Z.memory.totalJSHeapSize), usedJSHeapSize: Cn(Z.memory.usedJSHeapSize) }) };
              })();
              ...
              this._recordStop = Fe({ ignoreClass: "highlight-ignore", blockClass: "highlight-block", emit: m, recordCrossOriginIframes: this.options.recordCrossOriginIframe, privacySetting: this.privacySetting, maskAllInputs: y, maskInputOptions: G, recordCanvas: this.enableCanvasRecording, sampling: { canvas: { fps: this.samplingStrategy.canvas, fpsManual: this.samplingStrategy.canvasManualSnapshot, resizeFactor: this.samplingStrategy.canvasFactor, clearWebGLBuffer: this.samplingStrategy.canvasClearWebGLBuffer, initialSnapshotDelay: this.samplingStrategy.canvasInitialSnapshotDelay, dataURLOptions: this.samplingStrategy.dataUrlOptions, maxSnapshotDimension: this.samplingStrategy.canvasMaxSnapshotDimension } }, keepIframeSrcFn: (Z) => !this.options.recordCrossOriginIframe, inlineImages: this.inlineImages, inlineStylesheet: this.inlineStylesheet, plugins: [Jr()], logger: typeof this.options.debug == "boolean" && this.options.debug || typeof this.options.debug == "object" && this.options.debug.domRecording ? { debug: this.logger.log, warn: Ut } : void 0 }), X || this.options.recordCrossOriginIframe && this._setupCrossOriginIframeParent(), document.referrer && (window && document.referrer.includes(window.location.origin) || (this.addCustomEvent("Referrer", document.referrer), this.addProperties({ referrer: document.referrer }, { type: "session" }))), this._setupWindowListeners(), this.ready = true, this.state = "Recording", this.manualStopped = false;
            } catch (l) {
      ...
      _visibilityHandler(e) {
        return ne(this, null, function* () {
          this.manualStopped ? this.logger.log("Ignoring visibility event due to manual stop.") : (/* @__PURE__ */ new Date()).getTime() - this._lastVisibilityChangeTime < 100 || (this._lastVisibilityChangeTime = (/* @__PURE__ */ new Date()).getTime(), this.logger.log(`Detected window ${e ? "hidden" : "visible"}.`), e ? (this.addCustomEvent("TabHidden", true), this.options.disableBackgroundRecording && this.stopRecording()) : (this.options.disableBackgroundRecording && (yield this.initialize()), this.addCustomEvent("TabHidden", false)));
        });
      }
      ...
      _setupWindowListeners() {
        ...
        try {
          const n = this;
          this.enableSegmentIntegration && this.listeners.push(ql((o) => {
            if (o.type === "track") {
              const r = {};
          ...
          })), this.listeners.push(ol((o) => {
            this.reloaded ? (this.addCustomEvent("Reload", o), this.reloaded = false, n.addProperties({ reload: true }, { type: "session" })) : this.addCustomEvent("Navigate", o), n.addProperties({ "visited-url": o }, { type: "session" });
          ...
          })), this.listeners.push(pa((o) => {
            const { name: r, value: a } = o;
            this.recordMetric([{ name: r, value: a, group: window.location.href, category: Re.WebVital }]);
          })), this.sessionShortcut && ta(this.sessionShortcut, () => {
            window.open(this.getCurrentSessionURLWithTimestamp(), "_blank");
          }), this.enablePerformanceRecording && (this.listeners.push(((o, r) => {
            let a = 0, l = 0;
            const c = () => {
              const X = ((/* @__PURE__ */ new Date()).getTime() - r) / 1e3, y = Ao.memory.jsHeapSizeLimit || 0, G = Ao.memory.usedJSHeapSize || 0;
              o({ jsHeapSizeLimit: y, usedJSHeapSize: G, relativeTimestamp: X, fps: a });
            };
            let d;
            c(), d = setInterval(() => {
              c();
            ...
            return window.addEventListener("click", c, true), window.addEventListener("keydown", c, true), () => {
              window.removeEventListener("keydown", c, true), window.removeEventListener("click", c, true);
            };
          })((o) => {
          ...
          })((o) => this._visibilityHandler(o)), this.logger.log("Set up document visibility listener.")), this._hasPreviouslyInitialized = true);
          const s = () => {
            this.hasSessionUnloaded = true, this.pushPayloadTimerId && (clearTimeout(this.pushPayloadTimerId), this.pushPayloadTimerId = void 0);
          };
        ...
        return ne(this, null, function* () {
          ...
          try {
            ...
            this.state === "Recording" && this.listeners && this.sessionData.sessionStartTime && Date.now() - this.sessionData.sessionStartTime > 144e5 && (this.logger.log("Resetting session", { start: this.sessionData.sessionStartTime }), yield this._reset({})), ((e = this.options) == null ? void 0 : e.sendMode) === "local" && (i = (n) => ne(this, null, function* () {
              let s = new Blob([JSON.stringify({ query: go(fo), variables: n })], { type: "application/json" });
              return yield window.fetch(`${this._backendUrl}`, { method: "POST", body: s }), 0;
            })), yield this._sendPayload({ sendFn: i }), this.hasPushedData = true, this.sessionData.lastPushTime = Date.now();
          } catch (i) {
...
SessionSecureID: ${this.sessionData.sessionSecureID}`);
    ...
    const Xa = Object.freeze(Object.defineProperty({ __proto__: null, shutdown: () => ne(this, null, function* () {
    }) }, Symbol.toStringTag, { value: "Module" }));
    fe.FirstLoadListeners = He, fe.GenerateSecureID = Gi, fe.Highlight = kn, fe.HighlightWarning = Ut, fe.MetricCategory = Re, fe.getPreviousSessionData = Qs, Object.defineProperty(fe, Symbol.toStringTag, { value: "Module" });
  });
})(Ln, Ln.exports);
var Fa = Ln.exports;
var Ea = Ua({
...
//# sourceMappingURL=index-mTHZ-EGL-FJNG3J5V.js.map
