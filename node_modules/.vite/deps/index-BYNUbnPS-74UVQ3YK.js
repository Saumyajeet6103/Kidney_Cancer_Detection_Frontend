...
// node_modules/.pnpm/highlight.run@9.1.2/node_modules/highlight.run/dist/index-BYNUbnPS.js
var In = Object.defineProperty;
var Cn = (e, t, r) => t in e ? In(e, t, { enumerable: true, configurable: true, writable: true, value: r }) : e[t] = r;
...
var Bn = typeof globalThis == "object" ? globalThis : typeof self == "object" ? self : typeof window == "object" ? window : typeof global == "object" ? global : {};
var te = "1.8.0";
var Kt = /^(\d+)\.(\d+)\.(\d+)(-(.+))?$/;
function Gn(e) {
...
var kn = Gn(te);
var $n = te.split(".")[0];
var Re = Symbol.for("opentelemetry.js.api." + $n);
var Me = Bn;
function Le(e, t, r, n) {
  var i;
  n === void 0 && (n = false);
  ...
  return a[e] = t, r.debug("@opentelemetry/api: Registered a global for " + e + " v" + te + "."), true;
}
function ie(e) {
...
function he(e, t, r) {
  var n = ie("diag");
  if (n)
    return r.unshift(t), n[e].apply(n, Vn([], Fn(r), false));
}
var y;
(function(e) {
    ...
    function e() {
      function t(i) {
        return function() {
          ...
          var s = ie("diag");
          if (s)
            return s[i].apply(s, Xn([], jn(a), false));
        };
      }
      var r = this, n = function(i, a) {
        ...
        if (a === void 0 && (a = { logLevel: y.INFO }), i === r) {
          ...
          return r.error((o = _.stack) !== null && o !== void 0 ? o : _.message), false;
        }
        typeof a == "number" && (a = {
          logLevel: a
        });
...
var Jn = Symbol("BaggageEntryMetadata");
var Qn = B.instance();
function Zn(e) {
  ...
  function() {
    ...
    return e.prototype.active = function() {
      ...
      for (var i = [], a = 3; a < arguments.length; a++)
        i[a - 3] = arguments[a];
      return r.call.apply(r, Si([n], vi(i), false));
  ...
  function() {
    ...
    return e.getInstance = function() {
      ...
      for (var i, a = [], o = 3; o < arguments.length; o++)
        a[o - 3] = arguments[o];
      return (i = this._getContextManager()).with.apply(i, mi([t, r, n], Oi(a), false));
    }, e.prototype.bind = function(t, r) {
...
var Or = "0000000000000000";
var mr = "00000000000000000000000000000000";
var Nr = {
  traceId: mr,
  spanId: Or,
  traceFlags: G.NONE
...
var Bt = wt("OpenTelemetry Context Key SPAN");
function Gt(e) {
...
var $t = wt("OpenTelemetry Baggage Key");
function Mr(e) {
...
var P = ji.getInstance();
var Ir = wt("OpenTelemetry SDK Context Key SUPPRESS_TRACING");
function Cr(e) {
  return e.setValue(Ir, true);
}
function Ft(e) {
  return e.getValue(Ir) === true;
}
var Xi = "=";
var yt = ";";
var Xe = ",";
...
function xr(e) {
  return e == null ? true : Array.isArray(e) ? ta(e) : Ur(e);
}
function ta(e) {
  var t, r, n;
  try {
...
var Pe = typeof globalThis == "object" ? globalThis : typeof self == "object" ? self : typeof window == "object" ? window : typeof global == "object" ? global : {};
var oa = ",";
var sa = ["OTEL_SDK_DISABLED"];
function ua(e) {
...
var ma = "http.url";
var Na = "http.user_agent";
var lt = ma;
var Pa = Na;
var ya = "cloud.provider";
var ga = "cloud.account.id";
var Ra = "cloud.region";
var Ma = "cloud.availability_zone";
var Ia = "cloud.platform";
var Ca = "aws.ecs.container.arn";
var La = "aws.ecs.cluster.arn";
var ba = "aws.ecs.launchtype";
var Da = "aws.ecs.task.arn";
var wa = "aws.ecs.task.family";
var xa = "aws.ecs.task.revision";
var Ua = "aws.eks.cluster.arn";
var Ba = "aws.log.group.names";
var Ga = "aws.log.group.arns";
var ka = "aws.log.stream.names";
var $a = "aws.log.stream.arns";
var Fa = "container.name";
var Va = "container.id";
var Ha = "container.runtime";
var Ya = "container.image.name";
var ja = "container.image.tag";
var Xa = "deployment.environment";
var Wa = "device.id";
var Ka = "device.model.identifier";
var qa = "device.model.name";
var za = "faas.name";
var Ja = "faas.id";
var Qa = "faas.version";
var Za = "faas.instance";
var eo = "faas.max_memory";
var to = "host.id";
var ro = "host.name";
var no = "host.type";
var io = "host.arch";
var ao = "host.image.name";
var oo = "host.image.id";
var so = "host.image.version";
var uo = "k8s.cluster.name";
var _o = "k8s.node.name";
var co = "k8s.node.uid";
var Eo = "k8s.namespace.name";
var fo = "k8s.pod.uid";
var po = "k8s.pod.name";
var lo = "k8s.container.name";
var To = "k8s.replicaset.uid";
var ho = "k8s.replicaset.name";
var vo = "k8s.deployment.uid";
var So = "k8s.deployment.name";
var Ao = "k8s.statefulset.uid";
var Oo = "k8s.statefulset.name";
var mo = "k8s.daemonset.uid";
var No = "k8s.daemonset.name";
var Po = "k8s.job.uid";
var yo = "k8s.job.name";
var go = "k8s.cronjob.uid";
var Ro = "k8s.cronjob.name";
var Mo = "os.type";
var Io = "os.description";
var Co = "os.name";
var Lo = "os.version";
var bo = "process.pid";
var Do = "process.executable.name";
var wo = "process.executable.path";
var xo = "process.command";
var Uo = "process.command_line";
var Bo = "process.command_args";
var Go = "process.owner";
var ko = "process.runtime.name";
var $o = "process.runtime.version";
var Fo = "process.runtime.description";
var Vo = "service.name";
var Ho = "service.namespace";
var Yo = "service.instance.id";
var jo = "service.version";
var Xo = "telemetry.sdk.name";
var Wo = "telemetry.sdk.language";
var Ko = "telemetry.sdk.version";
var qo = "telemetry.auto.version";
var zo = "webengine.name";
var Jo = "webengine.version";
var Qo = "webengine.description";
var x = Gr([
  ya,
  ga,
  Ra,
...
var oe;
var Tt = (oe = {}, oe[x.TELEMETRY_SDK_NAME] = "opentelemetry", oe[x.PROCESS_RUNTIME_NAME] = "browser", oe[x.TELEMETRY_SDK_LANGUAGE] = _s.WEBJS, oe[x.TELEMETRY_SDK_VERSION] = Oa, oe);
var cs = 9;
var ds = 6;
var Es = Math.pow(10, ds);
var We2 = Math.pow(10, cs);
function j(e) {
...
function kr(e, t) {
  ...
  return r[1] >= We2 && (r[1] -= We2, r[0] += 1), r;
}
var W;
(function(e) {
...
var Rt = "[_0-9a-z-*/]";
var ls = "[a-z]" + Rt + "{0,255}";
var Ts = "[a-z0-9]" + Rt + "{0,240}@[a-z]" + Rt + "{0,13}";
var hs = new RegExp("^(?:" + ls + "|" + Ts + ")$");
var vs = /^[ -~]{0,255}[!-~]$/;
var Ss = /,|=/;
function As(e) {
  return hs.test(e);
...
var Rs = "(?![0]{16})[\\da-f]{16}";
var Ms = "[\\da-f]{2}";
var Is = new RegExp("^\\s?(" + ys + ")-(" + gs + ")-(" + Rs + ")-(" + Ms + ")(-.*)?\\s?$");
function Cs(e) {
  var t = Is.exec(e);
...
var bs = "[object Null]";
var Ds = "[object Undefined]";
var ws = Function.prototype;
var Vr = ws.toString;
var xs = Vr.call(Object);
var Us = Bs(Object.getPrototypeOf, Object);
var Hr = Object.prototype;
var Yr = Hr.hasOwnProperty;
var Z = Symbol ? Symbol.toStringTag : void 0;
var jr = Hr.toString;
function Bs(e, t) {
  return function(r) {
    return e(t(r));
...
function $s(e) {
  var t = Yr.call(e, Z), r = e[Z], n = false;
  try {
    e[Z] = void 0, n = true;
  } catch (a) {
  }
...
var jt = (
  ...
  function() {
    function e(t, r) {
      this._callback = t, this._that = r, this._isCalled = false, this._deferred = new Xs();
    }
    return Object.defineProperty(e.prototype, "isCalled", {
      ...
      if (!this._isCalled) {
        this._isCalled = true;
        try {
          Promise.resolve((t = this._callback).call.apply(t, Ks([this._that], Ws(n), false))).then(function(a) {
...
var Qs = "aws.lambda.invoked_arn";
var Zs = "db.system";
var eu = "db.connection_string";
var tu = "db.user";
var ru = "db.jdbc.driver_classname";
var nu = "db.name";
var iu = "db.statement";
var au = "db.operation";
var ou = "db.mssql.instance_name";
var su = "db.cassandra.keyspace";
var uu = "db.cassandra.page_size";
var _u = "db.cassandra.consistency_level";
var cu = "db.cassandra.table";
var du = "db.cassandra.idempotence";
var Eu = "db.cassandra.speculative_execution_count";
var fu = "db.cassandra.coordinator.id";
var pu = "db.cassandra.coordinator.dc";
var lu = "db.hbase.namespace";
var Tu = "db.redis.database_index";
var hu = "db.mongodb.collection";
var vu = "db.sql.table";
var Su = "exception.type";
var Au = "exception.message";
var Ou = "exception.stacktrace";
var mu = "exception.escaped";
var Nu = "faas.trigger";
var Pu = "faas.execution";
var yu = "faas.document.collection";
var gu = "faas.document.operation";
var Ru = "faas.document.time";
var Mu = "faas.document.name";
var Iu = "faas.time";
var Cu = "faas.cron";
var Lu = "faas.coldstart";
var bu = "faas.invoked_name";
var Du = "faas.invoked_provider";
var wu = "faas.invoked_region";
var xu = "net.transport";
var Uu = "net.peer.ip";
var Bu = "net.peer.port";
var Gu = "net.peer.name";
var ku = "net.host.ip";
var $u = "net.host.port";
var Fu = "net.host.name";
var Vu = "net.host.connection.type";
var Hu = "net.host.connection.subtype";
var Yu = "net.host.carrier.name";
var ju = "net.host.carrier.mcc";
var Xu = "net.host.carrier.mnc";
var Wu = "net.host.carrier.icc";
var Ku = "peer.service";
var qu = "enduser.id";
var zu = "enduser.role";
var Ju = "enduser.scope";
var Qu = "thread.id";
var Zu = "thread.name";
var e_ = "code.function";
var t_ = "code.namespace";
var r_ = "code.filepath";
var n_ = "code.lineno";
var i_ = "http.method";
var a_ = "http.url";
var o_ = "http.target";
var s_ = "http.host";
var u_ = "http.scheme";
var __ = "http.status_code";
var c_ = "http.flavor";
var d_ = "http.user_agent";
var E_ = "http.request_content_length";
var f_ = "http.request_content_length_uncompressed";
var p_ = "http.response_content_length";
var l_ = "http.response_content_length_uncompressed";
var T_ = "http.server_name";
var h_ = "http.route";
var v_ = "http.client_ip";
var S_ = "aws.dynamodb.table_names";
var A_ = "aws.dynamodb.consumed_capacity";
var O_ = "aws.dynamodb.item_collection_metrics";
var m_ = "aws.dynamodb.provisioned_read_capacity";
var N_ = "aws.dynamodb.provisioned_write_capacity";
var P_ = "aws.dynamodb.consistent_read";
var y_ = "aws.dynamodb.projection";
var g_ = "aws.dynamodb.limit";
var R_ = "aws.dynamodb.attributes_to_get";
var M_ = "aws.dynamodb.index_name";
var I_ = "aws.dynamodb.select";
var C_ = "aws.dynamodb.global_secondary_indexes";
var L_ = "aws.dynamodb.local_secondary_indexes";
var b_ = "aws.dynamodb.exclusive_start_table";
var D_ = "aws.dynamodb.table_count";
var w_ = "aws.dynamodb.scan_forward";
var x_ = "aws.dynamodb.segment";
var U_ = "aws.dynamodb.total_segments";
var B_ = "aws.dynamodb.count";
var G_ = "aws.dynamodb.scanned_count";
var k_ = "aws.dynamodb.attribute_definitions";
var $_ = "aws.dynamodb.global_secondary_index_updates";
var F_ = "messaging.system";
var V_ = "messaging.destination";
var H_ = "messaging.destination_kind";
var Y_ = "messaging.temp_destination";
var j_ = "messaging.protocol";
var X_ = "messaging.protocol_version";
var W_ = "messaging.url";
var K_ = "messaging.message_id";
var q_ = "messaging.conversation_id";
var z_ = "messaging.message_payload_size_bytes";
var J_ = "messaging.message_payload_compressed_size_bytes";
var Q_ = "messaging.operation";
var Z_ = "messaging.consumer_id";
var ec = "messaging.rabbitmq.routing_key";
var tc = "messaging.kafka.message_key";
var rc = "messaging.kafka.consumer_group";
var nc = "messaging.kafka.client_id";
var ic = "messaging.kafka.partition";
var ac = "messaging.kafka.tombstone";
var oc = "rpc.system";
var sc = "rpc.service";
var uc = "rpc.method";
var _c = "rpc.grpc.status_code";
var cc = "rpc.jsonrpc.version";
var dc = "rpc.jsonrpc.request_id";
var Ec = "rpc.jsonrpc.error_code";
var fc = "rpc.jsonrpc.error_message";
var pc = "message.type";
var lc = "message.id";
var Tc = "message.compressed_size";
var hc = "message.uncompressed_size";
var F = Js([
  Qs,
  Zs,
  eu,
  ...
  function() {
    function e(t, r, n, i, a, o, s, u, _, c) {
      s === void 0 && (s = []), this.attributes = {}, this.links = [], this.events = [], this._droppedAttributesCount = 0, this._droppedEventsCount = 0, this._droppedLinksCount = 0, this.status = {
        code: Pt.UNSET
      }, this.endTime = [0, 0], this._ended = false, this._duration = [-1, -1], this.name = n, this._spanContext = i, this.parentSpanId = o, this.kind = a, this.links = s;
      var E = Date.now();
    ...
    return e.prototype.spanContext = function() {
      ...
      this._ended = true, this.endTime = this._getTime(t), this._duration = fs(this.startTime, this.endTime), this._duration[0] < 0 && (S.warn("Inconsistent start and end time, startTime > endTime. Setting span duration to 0ms.", this.startTime, this.endTime), this.endTime = this.startTime.slice(), this._duration = [0, 0]), this._droppedEventsCount > 0 && S.warn("Dropped " + this._droppedEventsCount + " events because eventCountLimit reached"), this._spanProcessor.onEnd(this);
...
var gc = (
  ...
  function() {
    function e(t, r) {
      this._exporter = t, this._isExporting = false, this._finishedSpans = [], this._droppedSpansCount = 0;
      var n = g();
    ...
    return e.prototype.forceFlush = function() {
      ...
      if (!this._isExporting) {
        var r = function() {
          t._isExporting = true, t._flushOneBatch().finally(function() {
            t._isExporting = false, t._finishedSpans.length > 0 && (t._clearTimer(), t._maybeStartTimer());
          }).catch(function(n) {
            t._isExporting = false, ne(n);
          });
        };
...
var Qr = (
  ...
  function(e) {
    ...
    return t.prototype.onInit = function(r) {
      var n = this;
      (r == null ? void 0 : r.disableAutoFlushOnDocumentHide) !== true && typeof document != "undefined" && (this._visibilityChangeListener = function() {
...
var Lc = (
  ...
  function() {
    ...
    return e.prototype.startSpan = function(t, r, n) {
      var i, a, o;
      r === void 0 && (r = {}), n === void 0 && (n = O2.active()), r.root && (n = P.deleteSpan(n));
      var s = P.getSpan(n);
      if (Ft(n)) {
      ...
      if (!(arguments.length < 2)) {
        arguments.length === 2 ? s = r : arguments.length === 3 ? (a = r, s = n) : (a = r, o = n, s = i);
        var u = o != null ? o : O2.active(), _ = this.startSpan(t, a, u), c = P.setSpan(u, _);
        return O2.with(c, s, void 0, _);
      }
...
var wc = function(e, t) {
  ...
  function u(_) {
      ...
      try {
        ...
        switch (i = 0, a && (_ = [_[0] & 2, a.value]), _[0]) {
          ...
          case 1:
            ...
            break;
          case 4:
            return r.label++, { value: _[1], done: false };
          case 5:
            r.label++, i = _[1], _ = [0];
            continue;
          case 7:
    ...
    if (_[0] & 5)
      throw _[1];
    return { value: _[0] ? _[1] : void 0, done: true };
  }
};
var xc = function(e, t) {
  var r = typeof Symbol == "function" && e[Symbol.iterator];
  ...
  function() {
    function e(t, r) {
      ...
      this._attributes = t, this.asyncAttributesPending = r != null, this._syncAttributes = (i = this._attributes) !== null && i !== void 0 ? i : {}, this._asyncAttributesPromise = r == null ? void 0 : r.then(function(a) {
        return n._attributes = Object.assign({}, n._attributes, a), n.asyncAttributesPending = false, a;
      }, function(a) {
        return S.debug("a resource's async attributes promise rejected: %s", a), n.asyncAttributesPending = false, {};
      });
    }
...
var Gc = (
  ...
  function() {
    ...
    return e.prototype.getTracer = function(t, r, n) {
      ...
      t === void 0 && (t = {}), P.setGlobalTracerProvider(this), t.propagator === void 0 && (t.propagator = this._buildPropagatorFromEnv()), t.contextManager && O2.setGlobalContextManager(t.contextManager), t.propagator && b.setGlobalPropagator(t.propagator);
    }, e.prototype.forceFlush = function() {
...
var Zr = (
  ...
  function() {
    function e() {
      this._enabled = false, this._currentContext = Q;
    }
    return e.prototype._bindFunction = function(t, r) {
      ...
      return this._currentContext = Q, this._enabled = false, this;
    }, e.prototype.enable = function() {
      return this._enabled ? this : (this._enabled = true, this._currentContext = Q, this);
    }, e.prototype.with = function(t, r, n) {
      for (var i = [], a = 3; a < arguments.length; a++)
        i[a - 3] = arguments[a];
      ...
      try {
        return r.call.apply(r, jc([n], Yc(i), false));
      } finally {
...
function M(e, t, r, n) {
  ...
  J2(r, t) && typeof r[t] == "number" && (i = r[t]);
  var o = n || T.FETCH_START;
  if (J2(r, o) && typeof r[o] == "number" && (a = r[o]), i !== void 0 && a !== void 0 && i >= a)
    return e.addEvent(t, i), e;
}
function pe(e, t) {
  M(e, T.FETCH_START, t), M(e, T.DOMAIN_LOOKUP_START, t), M(e, T.DOMAIN_LOOKUP_END, t), M(e, T.CONNECT_START, t), J2(t, "name") && t.name.startsWith("https:") && M(e, T.SECURE_CONNECTION_START, t), M(e, T.CONNECT_END, t), M(e, T.REQUEST_START, t), M(e, T.RESPONSE_START, t), M(e, T.RESPONSE_END, t);
...
function zc(e, t, r) {
  for (var n = X2(r), i = X2(ye(t)), a = e[1], o, s = e.length, u = 1; u < s; u++) {
    var _ = e[u], c = X2(ye(_[T.FETCH_START])), E = X2(ye(_[T.RESPONSE_END])), f = n - E;
    c >= i && (!o || f < o) && (o = f, a = _);
  }
  return a;
}
function Jc(e, t, r, n, i, a) {
  var o = X2(t), s = X2(r), u = n.filter(function(_) {
    var c = X2(ye(_[T.FETCH_START])), E = X2(ye(_[T.RESPONSE_END]));
...
function rn(e, t) {
  ...
  if (t && r.indexOf("@id") > 0)
    return r;
  var n = "";
  return e.parentNode && (n += rn(e.parentNode, false)), n += r, n;
}
function Qc(e) {
  if (!e.parentNode)
    return 0;
...
function nn(e, t) {
  ...
  var n = H(e);
  return n.origin === en() ? true : r.some(function(i) {
    return Kr(e, i);
  });
}
var ed = (
...
var sr = new td();
var rd = typeof globalThis == "object" ? globalThis : typeof self == "object" ? self : typeof window == "object" ? window : typeof global == "object" ? global : {};
var Be = Symbol.for("io.opentelemetry.js.api.logs");
var Se = rd;
function nd(e, t, r) {
  return function(n) {
    return n === e ? t : r;
...
function sn(e, t, r) {
  ...
  return Ae(i, "__original", n), Ae(i, "__unwrap", function() {
    e[t] === i && Ae(e, t, n);
  }), Ae(i, "__wrapped", true), Ae(e, t, i), i;
}
function ud(e, t, r) {
  if (e)
    Array.isArray(e) || (e = [e]);
...
var cd = (
  ...
  function() {
    function e(t, r, n) {
      n === void 0 && (n = {}), this.instrumentationName = t, this.instrumentationVersion = r, this._wrap = Ge.wrap, this._unwrap = Ge.unwrap, this._massWrap = Ge.massWrap, this._massUnwrap = Ge.massUnwrap, this._config = Ct({ enabled: true }, n), this._diag = S.createComponentLogger({
        namespace: t
...
var Td = (
  ...
  function(e) {
    ...
    return t.prototype.init = function() {
      ...
      O2.with(b.extract(Q, { traceparent: a }), function() {
        var o, s = r._startSpan(ge.DOCUMENT_LOAD, T.FETCH_START, i);
        s && (O2.with(P.setSpan(O2.active(), s), function() {
          var u = r._startSpan(ge.DOCUMENT_FETCH, T.FETCH_START, i);
          u && (u.setAttribute(lt, location.href), O2.with(P.setSpan(O2.active(), u), function() {
            var _;
      ...
      if (J2(i, n) && typeof i[n] == "number") {
        var o = this.tracer.startSpan(r, {
          startTime: i[n]
        }, a ? P.setSpan(O2.active(), a) : void 0);
        return o;
      }
...
var vd = "aws.lambda.invoked_arn";
var Sd = "db.system";
var Ad = "db.connection_string";
var Od = "db.user";
var md = "db.jdbc.driver_classname";
var Nd = "db.name";
var Pd = "db.statement";
var yd = "db.operation";
var gd = "db.mssql.instance_name";
var Rd = "db.cassandra.keyspace";
var Md = "db.cassandra.page_size";
var Id = "db.cassandra.consistency_level";
var Cd = "db.cassandra.table";
var Ld = "db.cassandra.idempotence";
var bd = "db.cassandra.speculative_execution_count";
var Dd = "db.cassandra.coordinator.id";
var wd = "db.cassandra.coordinator.dc";
var xd = "db.hbase.namespace";
var Ud = "db.redis.database_index";
var Bd = "db.mongodb.collection";
var Gd = "db.sql.table";
var kd = "exception.type";
var $d = "exception.message";
var Fd = "exception.stacktrace";
var Vd = "exception.escaped";
var Hd = "faas.trigger";
var Yd = "faas.execution";
var jd = "faas.document.collection";
var Xd = "faas.document.operation";
var Wd = "faas.document.time";
var Kd = "faas.document.name";
var qd = "faas.time";
var zd = "faas.cron";
var Jd = "faas.coldstart";
var Qd = "faas.invoked_name";
var Zd = "faas.invoked_provider";
var eE = "faas.invoked_region";
var tE = "net.transport";
var rE = "net.peer.ip";
var nE = "net.peer.port";
var iE = "net.peer.name";
var aE = "net.host.ip";
var oE = "net.host.port";
var sE = "net.host.name";
var uE = "net.host.connection.type";
var _E = "net.host.connection.subtype";
var cE = "net.host.carrier.name";
var dE = "net.host.carrier.mcc";
var EE = "net.host.carrier.mnc";
var fE = "net.host.carrier.icc";
var pE = "peer.service";
var lE = "enduser.id";
var TE = "enduser.role";
var hE = "enduser.scope";
var vE = "thread.id";
var SE = "thread.name";
var AE = "code.function";
var OE = "code.namespace";
...
var RE = "http.host";
var ME = "http.scheme";
var IE = "http.status_code";
var CE = "http.flavor";
var LE = "http.user_agent";
var bE = "http.request_content_length";
var DE = "http.request_content_length_uncompressed";
var wE = "http.response_content_length";
var xE = "http.response_content_length_uncompressed";
var UE = "http.server_name";
var BE = "http.route";
var GE = "http.client_ip";
var kE = "aws.dynamodb.table_names";
var $E = "aws.dynamodb.consumed_capacity";
var FE = "aws.dynamodb.item_collection_metrics";
var VE = "aws.dynamodb.provisioned_read_capacity";
var HE = "aws.dynamodb.provisioned_write_capacity";
var YE = "aws.dynamodb.consistent_read";
var jE = "aws.dynamodb.projection";
var XE = "aws.dynamodb.limit";
var WE = "aws.dynamodb.attributes_to_get";
var KE = "aws.dynamodb.index_name";
var qE = "aws.dynamodb.select";
var zE = "aws.dynamodb.global_secondary_indexes";
var JE = "aws.dynamodb.local_secondary_indexes";
var QE = "aws.dynamodb.exclusive_start_table";
var ZE = "aws.dynamodb.table_count";
var ef = "aws.dynamodb.scan_forward";
var tf = "aws.dynamodb.segment";
var rf = "aws.dynamodb.total_segments";
var nf = "aws.dynamodb.count";
var af = "aws.dynamodb.scanned_count";
var of = "aws.dynamodb.attribute_definitions";
var sf = "aws.dynamodb.global_secondary_index_updates";
var uf = "messaging.system";
var _f = "messaging.destination";
var cf = "messaging.destination_kind";
var df = "messaging.temp_destination";
var Ef = "messaging.protocol";
var ff = "messaging.protocol_version";
var pf = "messaging.url";
var lf = "messaging.message_id";
var Tf = "messaging.conversation_id";
var hf = "messaging.message_payload_size_bytes";
var vf = "messaging.message_payload_compressed_size_bytes";
var Sf = "messaging.operation";
var Af = "messaging.consumer_id";
var Of = "messaging.rabbitmq.routing_key";
var mf = "messaging.kafka.message_key";
var Nf = "messaging.kafka.consumer_group";
var Pf = "messaging.kafka.client_id";
var yf = "messaging.kafka.partition";
var gf = "messaging.kafka.tombstone";
var Rf = "rpc.system";
var Mf = "rpc.service";
var If = "rpc.method";
var Cf = "rpc.grpc.status_code";
var Lf = "rpc.jsonrpc.version";
var bf = "rpc.jsonrpc.request_id";
var Df = "rpc.jsonrpc.error_code";
var wf = "rpc.jsonrpc.error_message";
var xf = "message.type";
var Uf = "message.id";
var Bf = "message.compressed_size";
var Gf = "message.uncompressed_size";
var ue = hd([
  vd,
  Sd,
  Ad,
...
var Ot;
var $f = 300;
var dr = typeof process == "object" && ((Ot = process.release) === null || Ot === void 0 ? void 0 : Ot.name) === "node";
var Ff = (
  /** @class */
  function(e) {
    kf(t, e);
    ...
    return t.prototype.init = function() {
      ...
      if (!nn(n, this._getConfig().propagateTraceHeaderCorsUrls)) {
        var i = {};
        b.inject(O2.active(), i), Object.keys(i).length > 0 && this._diag.debug("headers inject skipped due to CORS policy");
        return;
      }
      if (r instanceof Request)
        b.inject(O2.active(), r.headers, {
          set: function(a, o, s) {
        ...
        var i = {};
        b.inject(O2.active(), i), r.headers = Object.assign({}, i, r.headers || {});
      }
      ...
      return function(n) {
        ...
        return function() {
          ...
          return new Promise(function(A, N) {
            return O2.with(P.setSpan(O2.active(), E), function() {
...
var Hf = "aws.lambda.invoked_arn";
var Yf = "db.system";
var jf = "db.connection_string";
var Xf = "db.user";
var Wf = "db.jdbc.driver_classname";
var Kf = "db.name";
var qf = "db.statement";
var zf = "db.operation";
var Jf = "db.mssql.instance_name";
var Qf = "db.cassandra.keyspace";
var Zf = "db.cassandra.page_size";
var ep = "db.cassandra.consistency_level";
var tp = "db.cassandra.table";
var rp = "db.cassandra.idempotence";
var np = "db.cassandra.speculative_execution_count";
var ip = "db.cassandra.coordinator.id";
var ap = "db.cassandra.coordinator.dc";
var op = "db.hbase.namespace";
var sp = "db.redis.database_index";
var up = "db.mongodb.collection";
var _p = "db.sql.table";
var cp = "exception.type";
var dp = "exception.message";
var Ep = "exception.stacktrace";
var fp = "exception.escaped";
var pp = "faas.trigger";
var lp = "faas.execution";
var Tp = "faas.document.collection";
var hp = "faas.document.operation";
var vp = "faas.document.time";
var Sp = "faas.document.name";
var Ap = "faas.time";
var Op = "faas.cron";
var mp = "faas.coldstart";
var Np = "faas.invoked_name";
var Pp = "faas.invoked_provider";
var yp = "faas.invoked_region";
var gp = "net.transport";
var Rp = "net.peer.ip";
var Mp = "net.peer.port";
var Ip = "net.peer.name";
var Cp = "net.host.ip";
var Lp = "net.host.port";
var bp = "net.host.name";
var Dp = "net.host.connection.type";
var wp = "net.host.connection.subtype";
var xp = "net.host.carrier.name";
var Up = "net.host.carrier.mcc";
var Bp = "net.host.carrier.mnc";
var Gp = "net.host.carrier.icc";
var kp = "peer.service";
var $p = "enduser.id";
var Fp = "enduser.role";
var Vp = "enduser.scope";
var Hp = "thread.id";
var Yp = "thread.name";
var jp = "code.function";
var Xp = "code.namespace";
var Wp = "code.filepath";
var Kp = "code.lineno";
var qp = "http.method";
var zp = "http.url";
var Jp = "http.target";
var Qp = "http.host";
var Zp = "http.scheme";
var el = "http.status_code";
var tl = "http.flavor";
var rl = "http.user_agent";
var nl = "http.request_content_length";
var il = "http.request_content_length_uncompressed";
var al = "http.response_content_length";
var ol = "http.response_content_length_uncompressed";
var sl = "http.server_name";
var ul = "http.route";
var _l = "http.client_ip";
var cl = "aws.dynamodb.table_names";
var dl = "aws.dynamodb.consumed_capacity";
var El = "aws.dynamodb.item_collection_metrics";
var fl = "aws.dynamodb.provisioned_read_capacity";
var pl = "aws.dynamodb.provisioned_write_capacity";
var ll = "aws.dynamodb.consistent_read";
var Tl = "aws.dynamodb.projection";
var hl = "aws.dynamodb.limit";
var vl = "aws.dynamodb.attributes_to_get";
var Sl = "aws.dynamodb.index_name";
var Al = "aws.dynamodb.select";
var Ol = "aws.dynamodb.global_secondary_indexes";
var ml = "aws.dynamodb.local_secondary_indexes";
var Nl = "aws.dynamodb.exclusive_start_table";
var Pl = "aws.dynamodb.table_count";
var yl = "aws.dynamodb.scan_forward";
var gl = "aws.dynamodb.segment";
var Rl = "aws.dynamodb.total_segments";
var Ml = "aws.dynamodb.count";
var Il = "aws.dynamodb.scanned_count";
var Cl = "aws.dynamodb.attribute_definitions";
var Ll = "aws.dynamodb.global_secondary_index_updates";
var bl = "messaging.system";
var Dl = "messaging.destination";
var wl = "messaging.destination_kind";
var xl = "messaging.temp_destination";
var Ul = "messaging.protocol";
var Bl = "messaging.protocol_version";
var Gl = "messaging.url";
var kl = "messaging.message_id";
var $l = "messaging.conversation_id";
var Fl = "messaging.message_payload_size_bytes";
var Vl = "messaging.message_payload_compressed_size_bytes";
var Hl = "messaging.operation";
var Yl = "messaging.consumer_id";
var jl = "messaging.rabbitmq.routing_key";
var Xl = "messaging.kafka.message_key";
var Wl = "messaging.kafka.consumer_group";
var Kl = "messaging.kafka.client_id";
var ql = "messaging.kafka.partition";
var zl = "messaging.kafka.tombstone";
var Jl = "rpc.system";
var Ql = "rpc.service";
var Zl = "rpc.method";
var eT = "rpc.grpc.status_code";
var tT = "rpc.jsonrpc.version";
var rT = "rpc.jsonrpc.request_id";
var nT = "rpc.jsonrpc.error_code";
var iT = "rpc.jsonrpc.error_message";
var aT = "message.type";
var oT = "message.id";
var sT = "message.compressed_size";
var uT = "message.uncompressed_size";
var _e = Vf([
  Hf,
  Yf,
  jf,
  ...
  function(e) {
    ...
    return t.prototype.init = function() {
      ...
      if (!nn(i, this._getConfig().propagateTraceHeaderCorsUrls)) {
        var a = {};
        b.inject(O2.active(), a), Object.keys(a).length > 0 && this._diag.debug("headers inject skipped due to CORS policy");
        return;
      }
      var o = {};
      b.inject(O2.active(), o), Object.keys(o).forEach(function(s) {
        r.setRequestHeader(s, String(o[s]));
      });
    }, t.prototype._addChildSpan = function(r, n) {
      var i = this;
      O2.with(P.setSpan(O2.active(), r), function() {
      ...
      typeof a == "function" && ze2(function() {
        return a(r, n);
      }, function(o) {
      ...
      return function(c) {
        return function() {
          ...
          return m && A && O2.with(P.setSpan(O2.active(), m), function() {
...
function MT(e, t, r, n, i, a) {
  var o, s, u = false, _ = setTimeout(function() {
    if (clearTimeout(o), u = true, s.readyState === XMLHttpRequest.DONE) {
    ...
    Object.entries(Ze(Ze({}, h), r)).forEach(function(p) {
      ...
      if (s.readyState === XMLHttpRequest.DONE && u === false)
...
var CT = (
  ...
  function(e) {
    ...
    function t(r) {
      r === void 0 && (r = {});
      var n = e.call(this, r) || this;
      return n._useXHR = false, n._useXHR = !!r.headers || typeof navigator.sendBeacon != "function", n._useXHR ? n._headers = Object.assign({}, hT(r.headers), br(g().OTEL_EXPORTER_OTLP_HEADERS)) : n._headers = {}, n;
    }
...
var DT = typeof BigInt != "undefined" ? bT : X2;
function fr(e) {
  return e;
}
function fn(e) {
...
function xT(e) {
  ...
  if (e === void 0)
    return wT;
  var n = (t = e.useLongBits) !== null && t !== void 0 ? t : true, i = (r = e.useHex) !== null && r !== void 0 ? r : false;
  return {
...
function GT(e, t) {
  var r;
  return {
    attributes: e.attributes ? it2(e.attributes) : [],
...
function bt(e, t) {
  ...
  for (const i of e.body.matchAll(eh)) {
    if (typeof i.index == "number" || ZT(false), i.index >= t)
      break;
...
var Xt = class _Xt extends Error {
  /**
  ...
  constructor(t, ...r) {
    ...
    this.extensions = (a = E != null ? E : h) !== null && a !== void 0 ? a : /* @__PURE__ */ Object.create(null), Object.defineProperties(this, {
      ...
      writable: true,
      configurable: true
    }) : Error.captureStackTrace ? Error.captureStackTrace(this, _Xt) : Object.defineProperty(this, "stack", {
      value: Error().stack,
      writable: true,
      configurable: true
    });
...
function fh(e, t, r) {
  ...
  if (a === 46 && (o = true, a = n.charCodeAt(++i), i = Nt(e, i, a), a = n.charCodeAt(i)), (a === 69 || a === 101) && (o = true, a = n.charCodeAt(++i), (a === 43 || a === 45) && (a = n.charCodeAt(++i)), i = Nt(e, i, a), a = n.charCodeAt(i)), a === 46 || An(a))
    throw I(
      e.source,
      i,
...
var yn = class {
  constructor(t, r = "GraphQL request", n = {
    ...
    typeof t == "string" || mt(false, `Body must be a string. Received: ${Pn(t)}.`), this.body = t, this.name = r, this.locationOffset = n, this.locationOffset.line > 0 || mt(
      false,
...
var Ih = class {
   ...
   */
  node(t, r) {
    return this._options.noLocation !== true && (r.loc = new nh(
      t,
  ...
  expectOptionalKeyword(t) {
    const r = this._lexer.token;
    return r.kind === d.NAME && r.value === t ? (this.advanceLexer(), true) : false;
  }
  /**
...
var Ch = ["click", "input", "submit"];
function Lh() {
  return false;
}
var bh = class extends nt {
  constructor(r = {}) {
    var n;
  ...
  _createSpan(r, n) {
    ...
    try {
      ...
      }, n ? P.setSpan(O2.active(), n) : void 0);
      return r instanceof MouseEvent && (u.setAttribute("event.x", r.clientX), u.setAttribute("event.y", r.clientY), u.setAttribute("event.relativeX", r.clientX / window.innerWidth), u.setAttribute("event.relativeY", r.clientY / window.innerHeight), a === "scroll" && (u.setAttribute("event.scrollX", window.scrollX), u.setAttribute("event.scrollY", window.scrollY))), this._shouldPreventSpanCreation(a, i, u) === true ? void 0 : (this._spansData.set(u, {
        taskCount: 0
      }), u);
    } catch (u) {
  ...
  addPatchedListener(r, n, i, a) {
    ...
    let s = o.get(n);
    return s || (s = /* @__PURE__ */ new Map(), o.set(n, s)), s.has(r) ? false : (s.set(r, a), true);
  }
  /**
  ...
  _patchAddEventListener() {
    ...
    return (i) => function(o, s, u) {
      ...
      const _ = u && typeof u == "object" && u.once, c = function(...E) {
        ...
        return p ? (h && r._eventsSpanMap.set(h, p), O2.with(P.setSpan(O2.active(), p), () => {
...
var hr = { BASE_URL: "/", MODE: "production", DEV: false, PROD: true, SSR: false };
var Y;
var et = "highlight.record";
var $h = (e) => {
  var _, c, E, f, h;
  if (Y !== void 0) {
    ...
    instrumentations: [
      ...
      new Ff({
        ...
        applyCustomAttributesOnSpan: (p, v, m) => ut(void 0, null, function* () {
          ...
          const K = yield it(m, (q = e.networkRecordingOptions) == null ? void 0 : q.bodyKeysToRecord, (we = e.networkRecordingOptions) == null ? void 0 : we.networkBodyKeysToRedact);
      ...
      new dT({
        ...
        applyCustomAttributesOnSpan: (p, v) => {
          var K, k;
          const m = v;
          if (p.attributes[et] === false)
            return;
          const N = vr(m._url, m._method, v.responseText);
          p.updateName(N), Sr(p, m._body, m._requestHeaders, e.networkRecordingOptions);
          const C = O(m._body, (K = e.networkRecordingOptions) == null ? void 0 : K.networkBodyKeysToRedact, (k = e.networkRecordingOptions) == null ? void 0 : k.bodyKeysToRecord, m._requestHeaders);
...
var Dh = class extends Qr {
  onEnd(t) {
    t.attributes[et] !== false && super.onEnd(t);
  }
};
var wh = class extends Fr {
  constructor(r) {
    super();
    $(this, "backendUrl");
    $(this, "tracingOrigins");
  ...
  inject(r, n, i) {
    ...
    if (typeof o == "string" && !Uh(o, this.backendUrl, this.tracingOrigins, this.urlBlocklist)) {
      a.setAttribute(et, false);
      return;
    }
    super.inject(r, n, i);
  }
};
var xh = "highlight-browser";
var Fh = () => Y.getTracer(xh);
var Vh = () => ut(void 0, null, function* () {
...
var Sr = (e, t, r, n) => {
  ...
  const o = We((s = n == null ? void 0 : n.networkHeadersToRedact) != null ? s : [], r, n == null ? void 0 : n.headerKeysToRecord);
  e.setAttributes({
...
var Uh = (e, t, r, n) => !!(n != null && n.some((o) => e.toLowerCase().includes(o))) || !J(e, t, r) ? false : X(e, r);
var Ar = (e) => {
  const r = e.events, n = {
...
//# sourceMappingURL=index-BYNUbnPS-74UVQ3YK.js.map
